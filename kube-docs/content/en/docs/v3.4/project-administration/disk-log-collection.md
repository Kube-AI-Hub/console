...
keywords: 'Kube AI Hub, Kubernetes, project, disk, log, collection'
...
Kube AI Hub supports multiple log collection methods so that Ops teams can collect, manage, and analyze logs in a unified and flexible way.
...
1. Log in to the web console of Kube AI Hub as `project-admin` and go to your project.

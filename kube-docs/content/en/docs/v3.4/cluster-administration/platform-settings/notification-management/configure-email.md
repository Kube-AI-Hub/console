...
keywords: 'Kube AI Hub, Kubernetes, custom, platform'
...
After you configure the email server and add recipients, you need to enable [Kube AI Hub Alerting](../../../../pluggable-components/alerting/) and create an alerting policy for workloads or nodes. Once it is triggered, all the recipients can receive email notifications.

{{< notice note >}}

- If you update your email server configuration, Kube AI Hub will send email notifications based on the latest configuration.
...
- As Kube AI Hub has built-in alerting policies, if you do not set any customized alerting policies, your recipient can still receive email notifications once a built-in alerting policy is triggered.

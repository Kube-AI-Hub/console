...
keywords: 'Kube AI Hub, Kubernetes, PVC, PV, Snapshot, Snapshot Classes'
description: 'Learn how to manage snapshot classes on Kube AI Hub.'
...
1. Log in to the web console of Kube AI Hub as `project-regular`. On the navigation pane on the left, click **Storage > Volume Snapshot Classes**.

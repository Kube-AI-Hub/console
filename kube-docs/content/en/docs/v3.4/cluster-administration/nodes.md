...
keywords: "Kubernetes, Kube AI Hub, taints, nodes, labels, requests, limits"
...
Currently, you cannot add or remove nodes directly from the Kube AI Hub console, but you can do it by using [KubeKey](https://github.com/kubesphere/kubekey). For more information, see [Add New Nodes](../../installing-on-linux/cluster-operation/add-new-nodes/) and [Remove Nodes](../../installing-on-linux/cluster-operation/remove-nodes/).

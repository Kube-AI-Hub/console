...
weight: 8624
---
You can use Elasticsearch, Kafka and Fluentd as log receivers in Kube AI Hub. This tutorial demonstrates:
...
Usually, Fluentd is deployed as a DaemonSet in Kubernetes to collect container logs on each node. Kube AI Hub chooses Fluent Bit because of its low memory footprint. Besides, Fluentd features numerous output plugins. Hence, Kube AI Hub chooses to deploy Fluentd as a Deployment to forward logs it receives from Fluent Bit to more destinations such as S3, MongoDB, Cassandra, MySQL, syslog and Splunk.

---
title: "Deploy Kube AI Hub on QingCloud Instances"
keywords: "Kube AI Hub, Installation, HA, High-availability, LoadBalancer"
description: "Learn how to create a high-availability cluster on QingCloud platform."
linkTitle: "Deploy Kube AI Hub on QingCloud Instances"
Weight: 3420
---
...
2. On the load balancer's detail page, create a listener that listens on port `30880` (NodePort of Kube AI Hub console) with **Listener Protocol** set to `HTTP`.
...
3. Click **Add Backend**. In **Advanced Search**, choose the `six` machines on which you are going to install Kube AI Hub within the VxNet `pn`, and set the port to `30880`.
...
Inspect the logs of installation. When you see output logs as follows, it means Kube AI Hub has been successfully deployed.
...
In the web console of Kube AI Hub, you can also see that all the nodes are functioning well.

...
keywords: 'Kube AI Hub, Kubernetes, storage, installation, configuration'
...
Persistent volumes are a **must** for installing Kube AI Hub. When you use [KubeKey](../../../installing-on-linux/introduction/kubekey/) to set up a Kube AI Hub cluster, you can install different storage systems as [add-ons](https://github.com/kubesphere/kubekey/blob/master/docs/addons.md). The general steps of installing Kube AI Hub by KubeKey on Linux are:

1. Install Kubernetes.
2. Install any provided add-ons.
3. Install Kube AI Hub by [ks-installer](https://github.com/kubesphere/ks-installer).

...
keywords: 'Kube AI Hub, Kubernetes, QingCloud CSI, installation, configurations, storage'
description: 'Use KubeKey to create a cluster with QingCloud CSI providing storage services.'
linkTitle: "Install QingCloud CSI"
weight: 3320
---

If you plan to install Kube AI Hub on [QingCloud](https://www.qingcloud.com/), [QingCloud CSI](https://github.com/yunify/qingcloud-csi) can be chosen as the underlying storage plugin. 

This tutorial demonstrates how to use KubeKey to set up a Kube AI Hub cluster and configure QingCloud CSI to provide storage services.
...
You can verify that QingCloud CSI has been successfully installed either from the command line or from the Kube AI Hub web console.
...
3. Go to **Storage Classes** under **Storage**, and you can see available storage classes in your cluster.
   ...
   For more information about how to create volumes on the Kube AI Hub console, see [Volumes](../../../project-user-guide/storage/volumes/).

...
keywords: "Air-gapped, installation, Kube AI Hub"
description: "Understand how to install Kube AI Hub and Kubernetes in the air-gapped environment."

linkTitle: "Air-gapped Installation"
weight: 3140
---

KubeKey is an open-source, lightweight tool for deploying Kubernetes clusters. It allows you to install Kubernetes/K3s only, both Kubernetes/K3s and Kube AI Hub, and other cloud-native plugins in a flexible, fast, and convenient way. Additionally, it is an effective tool for scaling and upgrading clusters.
   ...
   spec:
     hosts:
       - {
           ...
           user: root,
           password: "<REPLACE_WITH_YOUR_ACTUAL_PASSWORD>",
         }
       - {
           name: node1,
           address: 192.168.0.4,
           internalAddress: 192.168.0.4,
           user: root,
           password: "<REPLACE_WITH_YOUR_ACTUAL_PASSWORD>",
         }
...
5. Create a Harbor project.
   ...
   # Copyright 2018 The Kube AI Hub Authors.
   #
...
7. Run the following command to install a Kube AI Hub cluster:

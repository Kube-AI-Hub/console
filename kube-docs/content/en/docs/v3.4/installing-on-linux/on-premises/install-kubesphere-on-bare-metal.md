...
keywords: 'Kubernetes, Kube AI Hub, bare-metal'
description: 'Learn how to create a multi-node cluster with one master on bare metal.'
linkTitle: "Deploy Kube AI Hub on Bare Metal"
weight: 3520
---

## Introduction

In addition to the deployment on cloud, Kube AI Hub can also be installed on bare metal. As the virtualization layer is removed, the infrastructure overhead is drastically reduced, which brings more compute and storage resources to app deployments. As a result, hardware efficiency is improved. Refer to the example below to deploy Kube AI Hub on bare metal.

## Prerequisites

- Make sure you already know how to install Kube AI Hub on a multi-node cluster based on the tutorial [Multi-node Installation](../../../installing-on-linux/introduction/multioverview/).

...
keywords: 'Kube AI Hub, Kubernetes, HA, high availability, installation, configuration'
...
[Kubekey](https://github.com/kubesphere/kubekey) is the next-gen installer which provides an easy, fast and flexible way to install Kubernetes and Kube AI Hub. Follow the steps below to download KubeKey.

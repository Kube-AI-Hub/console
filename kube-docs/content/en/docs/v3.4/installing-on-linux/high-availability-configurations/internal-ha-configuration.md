...
keywords: 'Kube AI Hub, Kubernetes, KubeKey, HA, Installation'
...
This document describes how to use the built-in high availability mode when installing Kube AI Hub on Linux.
...
![HA architecture](/images/docs/v3.x/installing-on-linux/high-availability-configurations/internal-ha-architecture.svg)
...
Kube AI Hub has decoupled some core feature components since v2.1.0. These components are designed to be pluggable which means you can enable them either before or after installation. By default, Kube AI Hub is installed with the minimal package if you do not enable them.

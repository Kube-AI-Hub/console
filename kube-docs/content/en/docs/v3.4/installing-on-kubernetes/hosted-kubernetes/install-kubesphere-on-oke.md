---
title: "Deploy Kube AI Hub on Oracle OKE"
keywords: 'Kubernetes, Kube AI Hub, OKE, Installation, Oracle-cloud'
description: 'Learn how to deploy Kube AI Hub on Oracle Cloud Infrastructure Container Engine for Kubernetes.'

weight: 4260
---

This guide walks you through the steps of deploying Kube AI Hub on [Oracle Kubernetes Engine](https://www.oracle.com/cloud/compute/container-engine-kubernetes.html).

## Create a Kubernetes Cluster

- A standard Kubernetes cluster in OKE is a prerequisite of installing Kube AI Hub. Go to the navigation menu and refer to the image below to create a cluster.
...
- Next, you need to set the cluster with basic information. Here is an example for your reference. When you finish, click **Next**.
  ...
  - It is recommended that you should select **Public** for **Visibility Type**, which will assign a public IP address for every node. The IP address can be used later to access the web console of Kube AI Hub.
...
Now that Kube AI Hub is installed, you can access the web console of Kube AI Hub either through `NodePort` or `LoadBalancer`.

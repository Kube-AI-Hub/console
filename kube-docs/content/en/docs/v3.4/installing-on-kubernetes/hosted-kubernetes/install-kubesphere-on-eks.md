---
title: "Deploy Kube AI Hub on AWS EKS"
keywords: 'Kubernetes, Kube AI Hub, EKS, Installation'
description: 'Learn how to deploy Kube AI Hub on Amazon Elastic Kubernetes Service.'

weight: 4220
---

This guide walks you through the steps of deploying Kube AI Hub on [AWS EKS](https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html). You also can visit [Kube AI Hub on AWS Quick Start](https://aws.amazon.com/quickstart/architecture/qingcloud-kubesphere/) which uses Amazon Web Services (AWS) CloudFormation templates to help end users automatically provision an Amazon Elastic Kubernetes Service (Amazon EKS) and Kube AI Hub environment on the AWS Cloud.
...
1. A standard Kubernetes cluster in AWS is a prerequisite of installing Kube AI Hub. Go to the navigation menu and refer to the image below to create a cluster.
...
Now that Kube AI Hub is installed, you can access the web console of Kube AI Hub by following the step below.

- Check the service of Kube AI Hub console through the following command.
...
- Access the web console of Kube AI Hub using the external IP generated by EKS.

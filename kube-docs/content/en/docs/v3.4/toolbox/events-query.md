---
title: "Event Query"
keywords: 'Kube AI Hub, Kubernetes, Event, Query'
...
[Kube AI Hub Events](../../pluggable-components/events/) needs to be enabled.
...
- Kube AI Hub supports event queries on each cluster separately if you have enabled the [multi-cluster feature](../../multicluster-management/). You can click <img src="/images/docs/v3.x/toolbox/event-query/drop-down-list.png" width='20' alt="icon" /> on the left of the search box and select a target cluster.

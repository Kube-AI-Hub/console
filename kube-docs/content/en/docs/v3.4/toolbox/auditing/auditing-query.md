...
keywords: "Kubernetes, Kube AI Hub, auditing, log, query"
...
Kube AI Hub supports the query of auditing logs among isolated tenants. This tutorial demonstrates how to use the query function, including the interface, search parameters and detail pages.

## Prerequisites

You need to enable [Kube AI Hub Auditing Logs](../../../pluggable-components/auditing-logs/).
...
- Kube AI Hub stores logs for the last seven days by default. You can modify the retention period in the ConfigMap `elasticsearch-logging-curator`.

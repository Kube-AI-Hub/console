...
keywords: "Kubernetes, Kube AI Hub, auditing, log, customize, receive"
...
To enable auditing logs, see [Kube AI Hub Auditing Logs](../../../pluggable-components/auditing-logs/).

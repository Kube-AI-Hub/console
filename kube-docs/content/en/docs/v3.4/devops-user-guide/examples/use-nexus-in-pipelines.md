...
keywords: 'Kube AI Hub, Kubernetes, Pipeline, Nexus, Jenkins'
description: 'Learn how to use Nexus in pipelines on Kube AI Hub.'
...
This tutorial demonstrates how to use Nexus in pipelines on Kube AI Hub.
...
1. Log out of the Kube AI Hub web console and log back in as `project-regular`. Go to your DevOps project and click **Create** on the **Pipelines** page.

...
keywords: 'Kubernetes, Kube AI Hub, DevOps, role, member'
...
In **DevOps Project Roles**, there are three available built-in roles as shown below. Built-in roles are created automatically by Kube AI Hub when a DevOps project is created and they cannot be edited or deleted.

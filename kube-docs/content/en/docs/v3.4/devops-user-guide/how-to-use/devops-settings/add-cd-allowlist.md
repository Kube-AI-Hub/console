...
keywords: 'Kubernetes, GitOps, Kube AI Hub, CI/CD, Allowlist'
description: 'Describe how to add a continuous deployment allowlist on Kube AI Hub.'
linkTitle: "Add a Continuous Deployment Allowlist"
weight: 11243
---
In Kube AI Hub 3.4, you can set an allowlist so that only specific code repositories and deployment locations can be used for continuous deployment.

...
keywords: 'Kubernetes, docker, Kube AI Hub, Jenkins, cicd, pipeline, dependency cache'
...
This tutorial demonstrates how to set CI nodes so that Kube AI Hub schedules tasks of pipelines and S2I/B2I builds to these nodes.
...
3. Click **Save**. Kube AI Hub will schedule tasks according to the taint you set. You can go back to work on your DevOps pipeline now.

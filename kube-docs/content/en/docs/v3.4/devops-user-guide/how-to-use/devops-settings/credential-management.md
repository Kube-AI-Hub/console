...
keywords: 'Kubernetes, Docker, Credential, Kube AI Hub, DevOps'
...
- You have enabled [Kube AI Hub DevOps System](../../../../pluggable-components/devops/).
...
Log in to the console of Kube AI Hub as `project-regular`. Navigate to your DevOps project, select **Credentials** and click **Create**.
1. Log in to the console of Kube AI Hub as `project-regular`.
...
2. You can also edit or delete credentials on this page. Note that when you edit credentials, Kube AI Hub does not display the existing username or password information. The previous one will be overwritten if you enter a new username and password.
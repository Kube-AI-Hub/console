---
title: "Set the Email Server for Kube AI Hub Pipelines"
keywords: 'Kube AI Hub, Kubernetes, notification, jenkins, devops, ci/cd, pipeline, email server'
description: 'Set the email server to receive notifications of your Jenkins pipelines.'
linkTitle: "Set Email Server for Kube AI Hub Pipelines"
Weight: 11218
---


The built-in Jenkins cannot share the same email configuration with the platform notification system. Thus, you need to configure email server settings for Kube AI Hub DevOps pipelines separately.

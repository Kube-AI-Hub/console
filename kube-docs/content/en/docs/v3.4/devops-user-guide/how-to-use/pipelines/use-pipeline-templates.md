...
keywords: 'Kube AI Hub, Kubernetes, Jenkins, Graphical Pipelines, Pipeline Templates'
description: 'Understand how to use pipeline templates on Kube AI Hub.'
linkTitle: "Use Pipeline Templates"
weight: 11213
---

Kube AI Hub offers a graphical editing panel where the stages and steps of a Jenkins pipeline can be defined through interactive operations. Kube AI Hub 3.4 provides built-in pipeline templates, such as Node.js, Maven, and Golang, to help users quickly create pipelines. Additionally, Kube AI Hub 3.4 also supports customization of pipeline templates to meet diversified needs of enterprises.
...
1. Log in to the Kube AI Hub console as `project-regular`. In the navigation pane on the left, click **DevOps Projects**.
...
In earlier versions, Kube AI Hub also provides the CI and CI & CD pipeline templates. However, as the two templates are hardly customizable, you are advised to use the Node.js, Maven, or Golang pipeline template, or directly customize a template based on your needs.

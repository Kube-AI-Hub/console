...
keywords: "Kube AI Hub, Kubernetes, DevOps, Jenkins, Agent"
description: "Learn how to customize a Jenkins agent on Kube AI Hub."
linkTitle: "Customize Jenkins Agent"
Weight: 112191
---

If you need to use a Jenkins agent that runs on a specific environment, for example, JDK 11, you can customize a Jenkins agent on Kube AI Hub.

This document describes how to customize a Jenkins agent on Kube AI Hub. 

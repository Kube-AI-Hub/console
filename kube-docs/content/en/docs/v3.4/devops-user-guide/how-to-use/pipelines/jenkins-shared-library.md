...
keywords: 'Kube AI Hub, Kubernetes, Jenkins, Shared Library, Pipelines'
...
This tutorial demonstrates how to use Jenkins shared libraries in Kube AI Hub DevOps pipelines.
...
1. Log in to the Kube AI Hub web console as `project-regular`. Go to your DevOps project and click **Create** on the **Pipelines** page.

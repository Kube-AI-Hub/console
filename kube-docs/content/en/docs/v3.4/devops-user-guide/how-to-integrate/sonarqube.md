...
keywords: 'Kubernetes, Kube AI Hub, DevOps, Jenkins, SonarQube, Pipeline'
description: 'Integrate SonarQube into your pipeline for code quality analysis.'
linkTitle: "Integrate SonarQube into Pipelines"
weight: 11310
---

[SonarQube](https://www.sonarqube.org/) is a popular continuous inspection tool for code quality. You can use it for static and dynamic analysis of a codebase. After it is integrated into pipelines in Kube AI Hub [Container Platform](https://kubesphere.io/), you can view common code issues such as bugs and vulnerabilities directly on the dashboard as SonarQube detects issues in a running pipeline.
...
3. Access Jenkins with the address `http://<Node IP>:30180`. When Kube AI Hub is installed, the Jenkins dashboard is also installed by default. Besides, Jenkins is configured with Kube AI Hub LDAP, which means you can log in to Jenkins with Kube AI Hub accounts (for example, `admin/P@88w0rd`) directly. For more information about configuring Jenkins, see [Jenkins System Settings](../../../devops-user-guide/how-to-use/pipelines/jenkins-setting/).
...
### Step 6: Add sonarqubeURL to the Kube AI Hub Console

You need to specify `sonarqubeURL` so that you can access SonarQube directly from the Kube AI Hub console.
...
## View Results on the Kube AI Hub Console

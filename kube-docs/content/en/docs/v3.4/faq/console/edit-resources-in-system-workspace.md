...
keywords: "system, resources, Kube AI Hub, Kubernetes"
...
1. Log in to Kube AI Hub as `admin`. Click <img src="/images/docs/v3.x/common-icons/hammer.png" height="25" width="25" alt="icon" /> in the lower-right corner and select **Kubectl**.

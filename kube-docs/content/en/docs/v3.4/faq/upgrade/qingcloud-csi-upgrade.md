...
keywords: "Kubernetes, upgrade, Kube AI Hub, v3.4.0"
description: "Upgrade the QingCloud CSI after you upgrade Kube AI Hub."
linkTitle: "Upgrade QingCloud CSI"
weight: 16210
---

## Upgrade QingCloud CSI after Upgrading Kube AI Hub

Currently QingCloud CSI cannot be upgraded by KubeKey. You can run the following command to upgrade the CSI manually after you upgrade Kube AI Hub:

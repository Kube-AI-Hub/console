...
keywords: "Session timeout, Kube AI Hub, Kubernetes"
description: "Understand session timeout and customize the timeout period."
linkTitle: "Session Timeout"
Weight: 16420
---

A session starts as a user logs in to the console of Kube AI Hub. You may see a message of "**Session timeout or this account is logged in elsewhere, please login again**" when the session expires.

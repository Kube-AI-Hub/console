...
keywords: "Kubernetes, Prometheus, Kube AI Hub, Monitoring"
...
## How to access the Prometheus console in Kube AI Hub

The Kube AI Hub monitoring engine is powered by Prometheus. For debugging purposes, you may want to access the built-in Prometheus service through a NodePort. Run the following command to change the service type to `NodePort`:
...
Chinese readers may refer to [the discussion](https://ask.kubesphere.io/forum/d/2027/16) in the Kube AI Hub China forum for more information.

...
keywords: "Kube AI Hub, Kubernetes, DevOps, Kubeconfig, AWS"
description: "How to create a DevOps kubeconfig on AWS"
linkTitle: "Create a DevOps Kubeconfig on AWS"
Weight: 16820
---

If you have trouble deploying applications into your project when running a pipeline on your AWS cluster with Kube AI Hub installed, it may be caused by the issue of DevOps kubeconfig. This tutorial demonstrates how to create a DevOps kubeconfig on AWS.

## Prerequisites

- You have an AWS cluster with Kube AI Hub installed. For more information about how to install Kube AI Hub on AWS, refer to [Deploy Kube AI Hub on AWS EKS](../../../installing-on-kubernetes/hosted-kubernetes/install-kubesphere-on-eks/).
...
1. Log in to your Kube AI Hub console of the AWS cluster and go to your DevOps project. Go to **Credentials** under **DevOps Project Settings**, and then click **Create**. You can name this kubeconfig based on your needs.

---
title: "Install Plugins to Jenkins in Kube AI Hub"
keywords: "Kube AI Hub, Kubernetes, DevOps, Jenkins, Plugin"
description: "How to install plugins to Jenkins in Kube AI Hub"
linkTitle: "Install Plugins to Jenkins in Kube AI Hub"
Weight: 16810
---

The Kube AI Hub DevOps System offers containerized CI/CD functions based on Jenkins. The primary means of enhancing the functionality of Jenkins is to install plugins. This tutorial demonstrates how to install plugins on the Jenkins dashboard.

{{< notice warning >}}

Not all Jenkins plugins have good maintaining support. Some plugins may lead to issues in Jenkins or even cause serious problems in Kube AI Hub. It is highly recommended that you make a backup before installing any plugin and run testing in another environment if you can.
...
2. You can get the output similar to the following. You can access the Jenkins dashboard through the address with your own Kube AI Hub account and password (for example, `admin/P@88w0rd`).
   ...
   Make sure you use your own address of Jenkins. You may also need to open the port in your security groups and configure related port forwarding rules depending on where your Kube AI Hub cluster is deployed.

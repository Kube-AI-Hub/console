...
section1:
  ...
  content: Learn how to build and manage cloud-native applications using Kube AI Hub Container Platform. Get documentation, example code, tutorials, and more.
...
sectionLink:
  docs:
    title: Popular Pages
    description: Learn how to use Kube AI Hub with these quickstarts, tutorials, and examples.
    list:
  ...
  videos:
    ...
    description: Watch video tutorials to learn about Kube AI Hub.
    list:
      ...
      - link: https://www.youtube.com/watch?v=c3V-2RX9yGY&t=160s
        text: A complete walkthrough to the Kube AI Hub DevOps system

section3:
  title: Run Kube AI Hub and Kubernetes Stack from the Cloud Service
  description: Cloud Providers are providing Kube AI Hub as a cloud-hosted service for users, helping you to create a highly available Kubernetes cluster managed by Kube AI Hub within minutes via several clicks. It enables you to use the cloud-hosted Kubernetes services out of the box.
  list:
  ...
  titleRight: Want to host Kube AI Hub on your cloud or your solution?

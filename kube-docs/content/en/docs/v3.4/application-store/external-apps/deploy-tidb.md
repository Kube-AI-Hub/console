---
title: "Deploy TiDB Operator and a TiDB Cluster on Kube AI Hub"
keywords: 'Kube AI Hub, Kubernetes, TiDB, TiDB Operator, TiDB Cluster'
description: 'Learn how to deploy TiDB Operator and a TiDB Cluster on Kube AI Hub.'
...
This tutorial demonstrates how to deploy TiDB Operator and a TiDB Cluster on Kube AI Hub.
...
1. Log in to the Kube AI Hub Web console as `admin`, and use **Kubectl** from the **Toolbox** in the bottom-right corner to execute the following command to install TiDB Operator CRD:
...
1. Log out of Kube AI Hub and log back in as `ws-admin`. In your workspace, go to **App Repositories** under **App Management**, and then click **Add**.
...
3. Your repository displays in the list after it is successfully imported to Kube AI Hub.

### Step 3: Deploy TiDB Operator

1. Log out of Kube AI Hub and log back in as `project-regular`. In your project, go to **Apps** under **Application Workloads** and click **Create**.

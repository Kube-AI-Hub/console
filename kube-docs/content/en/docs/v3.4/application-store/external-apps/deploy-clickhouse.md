---
title: "Deploy ClickHouse Operator and a ClickHouse Cluster on Kube AI Hub"
keywords: 'Kube AI Hub, Kubernetes, ClickHouse, ClickHouse Operator, ClickHouse Cluster'
description: 'Learn how to deploy ClickHouse Operator and a ClickHouse Cluster on Kube AI Hub.'
...
This tutorial demonstrates how to deploy ClickHouse Operator and a ClickHouse Cluster on Kube AI Hub.
...
1. Log in to the Kube AI Hub Web console as `admin`, and use **Kubectl** from the **Toolbox** in the lower-right corner to run the following command to install ClickHouse Operator. It is recommended that you have at least two worker nodes available in your cluster.
...
1. Log out of Kube AI Hub and log back in as `ws-admin`. In `demo-workspace`, go to **App Repositories** under **App Management**, and then click **Add**.
...
3. Your repository will display in the list after it is successfully imported to Kube AI Hub.

### Step 3: Deploy a ClickHouse Cluster

1. Log out of Kube AI Hub and log back in as `project-regular`. In `demo-project`, go to **Apps** under **Application Workloads** and click **Create**.
...
1. Log out of Kube AI Hub and log back in as `admin`. Hover your cursor over the hammer icon in the lower-right corner, and then select **Kubectl**.

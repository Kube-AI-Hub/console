---
title: 'Deploy Litmus on Kube AI Hub'
tag: 'Kube AI Hub, Kubernetes, Applications, Chaos engineering, Chaos experiments, Litmus'
keywords: 'Litmus,LitmusChaos,Kubernetes,Helm,Kube AI Hub'
description: 'Learn how to deploy Litmus on Kube AI Hub and create chaos experiments.'
linkTitle: "Deploy Litmus on Kube AI Hub"
Weight: 14350
---
...
This tutorial demonstrates how to deploy Litmus on Kube AI Hub and create chaos experiments.
...
1. Log out of the Kube AI Hub console and log back in as `project-regular`. In your project, go to **Apps** under **Application Workloads**, and then click **Create**.
...
10. Verify the workflow, and then click **Finish**.
    ...
    On the Kube AI Hub console, you can see that a Pod is being deleted and recreated.
...
2. On the Kube AI Hub console, you can see that the pod CPU usage is close to 1 core.

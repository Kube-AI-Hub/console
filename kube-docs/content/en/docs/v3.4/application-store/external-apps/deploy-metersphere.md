---
title: "Deploy MeterSphere on Kube AI Hub"
keywords: 'Kube AI Hub, Kubernetes, Applications, MeterSphere'
description: 'Learn how to deploy MeterSphere on Kube AI Hub.'
linkTitle: "Deploy MeterSphere on Kube AI Hub"
weight: 14330
---
...
This tutorial demonstrates how to deploy MeterSphere on Kube AI Hub.
...
1. Log in to Kube AI Hub as `ws-admin`. In your workspace, go to **App Repositories** under **App Management**, and then click **Add**.

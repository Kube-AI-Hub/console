---
title: "Deploy Meshery on Kube AI Hub"
keywords: 'Kubernetes, Kube AI Hub, Meshery,Serive Mesh, Layer5, app-store'
description: 'Learn how to deploy Meshery from the App Store of Kube AI Hub and access its service.'
linkTitle: "Deploy Meshery on Kube AI Hub"
weight: 14240
---
...
This tutorial walks you through an example of deploying Meshery from the App Store of Kube AI Hub.
...
6. Wait for the deployment to be finished. Upon completion, **Meshery** will be shown as **Running** in Kube AI Hub.

---
title: "Deploy etcd on Kube AI Hub"
keywords: 'Kubernetes, Kube AI Hub, etcd, app-store'
description: 'Learn how to deploy etcd from the App Store of Kube AI Hub and access its service.'
linkTitle: "Deploy etcd on Kube AI Hub"
weight: 14210
---
...
This tutorial walks you through an example of deploying etcd from the App Store of Kube AI Hub.
...
After the app is deployed, you can use etcdctl, a command-line tool for interacting with the etcd server, to access etcd on the Kube AI Hub console directly.
...
4. For clients within the Kube AI Hub cluster, the etcd service can be accessed through `<app name>.<project name>.svc.<K8s domain>:2379` (for example, `etcd-bqe0g4.demo-project.svc.cluster.local:2379` in this guide).

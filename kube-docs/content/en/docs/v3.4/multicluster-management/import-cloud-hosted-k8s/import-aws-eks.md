...
keywords: 'Kubernetes, Kube AI Hub, multicluster, Amazon EKS'
...
- You have a Kubernetes cluster with Kube AI Hub installed, and prepared this cluster as the host cluster. For more information about how to prepare a host cluster, refer to [Prepare a host cluster](../../../multicluster-management/enable-multicluster/direct-connection/#prepare-a-host-cluster).
- You have an EKS cluster to be used as the member cluster.

## Import an EKS Cluster

### Step 1: Deploy Kube AI Hub on your EKS cluster

You need to deploy Kube AI Hub on your EKS cluster first. For more information about how to deploy Kube AI Hub on EKS, refer to [Deploy Kube AI Hub on AWS EKS](../../../installing-on-kubernetes/hosted-kubernetes/install-kubesphere-on-eks/#install-kubesphere-on-eks).
...
2. Log in to the Kube AI Hub console of the EKS cluster as `admin`. Click **Platform** in the upper-left corner and then select **Cluster Management**.
...
2. Run the following commands on your local computer to get the token of the ServiceAccount `kubesphere` created by Kube AI Hub. It has the cluster admin access to the cluster and will be used as the new kubeconfig token.
...
1. Log in to the Kube AI Hub console on your host cluster as `admin`. Click **Platform** in the upper-left corner and then select **Cluster Management**. On the **Cluster Management** page, click **Add Cluster**.

...
keywords: 'Kubernetes, Kube AI Hub, multicluster, ACK'
...
- You have an ACK cluster with Kube AI Hub installed to be used as the member cluster.
...
2. Log in to the Kube AI Hub console of the ACK cluster as `admin`. Click **Platform** in the upper-left corner and then select **Cluster Management**.

...
keywords: 'Kubernetes, Kube AI Hub, multicluster, Google GKE'
...
### Step 1: Deploy Kube AI Hub on your GKE cluster

You need to deploy Kube AI Hub on your GKE cluster first. For more information about how to deploy Kube AI Hub on GKE, refer to [Deploy Kube AI Hub on GKE](../../../installing-on-kubernetes/hosted-kubernetes/install-kubesphere-on-gke/).
...
2. Log in to the Kube AI Hub console on GKE as `admin`. Click **Platform** in the upper-left corner and then select **Cluster Management**.

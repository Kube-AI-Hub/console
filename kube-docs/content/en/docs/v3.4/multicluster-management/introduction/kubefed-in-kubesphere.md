---
title: "Kube AI Hub Federation"
keywords: "Kubernetes, Kube AI Hub, federation, multicluster, hybrid-cloud"
description: "Understand the fundamental concept of Kubernetes federation in Kube AI Hub, including member clusters and host clusters."
linkTitle: "Kube AI Hub Federation"
weight: 5120
---
...
Before you use the central control plane of Kube AI Hub to manage multiple clusters, you need to create a host cluster, also known as **host** cluster. The host cluster, essentially, is a Kube AI Hub cluster with the multi-cluster feature enabled. It provides you with the control plane for unified management of member clusters, also known as **member** cluster. Member clusters are common Kube AI Hub clusters without the central control plane. Namely, tenants with necessary permissions (usually cluster administrators) can access the control plane from the host cluster to manage all member clusters, such as viewing and editing resources on member clusters. Conversely, if you access the web console of any member cluster separately, you cannot see any resources on other clusters.
...
Kube AI Hub features a powerful, inclusive central control plane so that you can manage any Kube AI Hub clusters in a unified way regardless of deployment environments or cloud providers.

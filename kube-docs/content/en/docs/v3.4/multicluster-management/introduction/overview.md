...
keywords: 'Kubernetes, Kube AI Hub, multicluster, hybrid-cloud'
description: 'Gain a basic understanding of multi-cluster management, such as its common use cases, and the benefits that Kube AI Hub can bring with its multi-cluster feature.'
linkTitle: "Overview"
weight: 5110
---
...
Kube AI Hub is developed to address multi-cluster and multi-cloud management challenges, including the scenarios mentioned above. It provides users with a unified control plane to distribute applications and its replicas to multiple clusters from public cloud to on-premises environments. Kube AI Hub also boasts rich observability across multiple clusters including centralized monitoring, logging, events, and auditing logs.

![multi-cluster-overview](/images/docs/v3.x/multicluster-management/introduction/overview/multi-cluster-overview.svg)

...
keywords: "Kubernetes, Kube AI Hub, GlusterFS"
...
Once you have GlusterFS and Heketi set up, you can install GlusterFS on your client machine and use KubeKey to create a Kube AI Hub cluster with GlusterFS as a storage class.
...
5. Create a JSON file for Heketi configurations.
   ...
   The account `admin` and its `key` value must be provided when you install GlusterFS as a storage class of your Kube AI Hub cluster.

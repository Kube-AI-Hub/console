---
title: "Monitoring"
keywords: 'Kubernetes, Kube AI Hub, API, Monitoring'
description: 'The API changes of the component **monitoring** in Kube AI Hub v3.4.0.'
...
In Kube AI Hub 3.4, the metrics on the left have been renamed to the ones on the right.
...
New metrics are introduced in Kube AI Hub 3.4.
...
In Kube AI Hub 3.4, the response fields `metrics_level`, `status` and `errorType` are removed.

---
title: "Glossary"
keywords: 'Kubernetes, Kube AI Hub, devops, docker, helm, jenkins, istio, prometheus, glossary'
description: 'The glossary used in Kube AI Hub.'
linkTitle: "Glossary"
weight: 17100
---

This glossary includes general terms and technical terms that are specific to Kube AI Hub.
...
- **ks-installer** <br>
    The package to deploy Kube AI Hub on existing Kubernetes clusters.
...
- **CI node** <br>
    A specific node for pipelines, S2I jobs or B2I jobs. Generally, applications often need to pull various dependencies during the building process. It might cause some issues like long pulling time, or unstable network causing failure. To build robust pipelines and speed up the building by using caches, you configure one or a set of CI nodes to which Kube AI Hub schedules the tasks of CI/CD pipelines and S2I/B2I.
...
- **Route** <br>
    A Kube AI Hub Route is a Kubernetes Ingress.

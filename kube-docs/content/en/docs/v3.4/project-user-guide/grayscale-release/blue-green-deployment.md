...
keywords: 'Kube AI Hub, Kubernetes, Service Mesh, Istio, Grayscale Release, Blue-Green deployment'
description: 'Learn how to release a blue-green deployment on Kube AI Hub.'
...
![blue-green-0](/images/docs/v3.x/project-user-guide/grayscale-release/blue-green-deployment/blue-green-0.svg)
...
1. Log in to Kube AI Hub as `project-regular` and go to **Grayscale Release**. Under **Release Modes**, click **Create** on the right of **Blue-Green Deployment**.
...
9. You can get the virtual service to identify the weight by running the following command:
   ...
   - If you want to run the command from the web kubectl on the Kube AI Hub console, you need to use the user `admin`.

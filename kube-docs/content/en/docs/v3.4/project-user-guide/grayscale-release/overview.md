...
keywords: 'Kubernetes, Kube AI Hub, grayscale release, overview, service mesh'
...
The current Kube AI Hub version does not support grayscale release strategies for multi-cluster apps.

...
MySQL is a built-in app in the Kube AI Hub App Store, which means it can be deployed and used directly once the App Store is enabled.
...
- The built-in MySQL template is provided by Kube AI Hub to help you monitor MySQL metrics. You can also add more metrics on the dashboard as needed.

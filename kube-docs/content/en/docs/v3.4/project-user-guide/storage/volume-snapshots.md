...
keywords: 'Kube AI Hub, Kubernetes, Volume, Snapshots'
description: 'Learn how to manage a snapshot of a persistent volume on Kube AI Hub.'
...
1. Log in to the web console of Kube AI Hub as `project-regular`. On the navigation pane on the left, choose **Storage > Volume Snapshots**.
...
1. Log in to the web console of Kube AI Hub as `project-regular`. On the **Persistent Volume Claims** page of your project, select a volume for which you want to create a snapshot.
...
1. Log in to the web console of Kube AI Hub as `project-regular`. On a snapshot's details page, click **Create Volume** to use the snapshot. Generally, the steps are the same as creating a PVC directly.
...
1. Log in to the web console of Kube AI Hub as `project-regular`. On the **Persistent Storage Claims** page of a project, click **Create**.

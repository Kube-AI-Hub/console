...
keywords: 'Kubernetes, Chart, Helm, Kube AI Hub, Application, App Store'
...
1. Log in to the web console of Kube AI Hub as `project-regular` and click **App Store** in the upper-left corner.

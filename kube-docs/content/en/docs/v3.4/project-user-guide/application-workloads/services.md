---
title: "Services"
keywords: 'Kube AI Hub, Kubernetes, services, workloads'
description: 'Learn basic concepts of Services and how to create Services in Kube AI Hub.'
linkTitle: "Services"
weight: 10240
---
...
In Kube AI Hub, stateful and stateless Services are created with a virtual IP by default. If you want to create a Headless Service, use **YAML** to configure it directly.
...
Kube AI Hub provides three basic methods to create a Service: **Stateless Service**, **Stateful Service**, and **External Service**. Besides, you can also customize a Service through **Specify Workload** and **Edit YAML** under **Customize Service**.

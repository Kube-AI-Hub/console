---
title: "Routes"
keywords: "Kube AI Hub, Kubernetes, Route, Ingress"
description: "Learn basic concepts of Routes (i.e. Ingress) and how to create Routes in Kube AI Hub."
weight: 10270
---

This document describes how to create, use, and edit a Route on Kube AI Hub.

A Route on Kube AI Hub is the same as an [Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/#what-is-ingress) on Kubernetes. You can use a Route and a single IP address to aggregate and expose multiple Services.
...
1. Log in to the Kube AI Hub web console as `project-admin` and go to your project.
...
1. Log out of the Kube AI Hub web console, log back in as `project-regular`, and go to the same project.
...
2. Select a mode, configure routing rules, click **√**, and click **Next**.
   ...
   * **Auto Generate**: Kube AI Hub automatically generates a domain name in the `<Service name>.<Project name>.<Gateway address>.nip.io` format and the domain name is automatically resolved by [nip.io](https://nip.io/) into the gateway address. This mode supports only HTTP.

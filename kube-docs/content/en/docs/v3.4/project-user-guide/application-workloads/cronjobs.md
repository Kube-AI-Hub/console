---
title: "CronJobs"
keywords: "Kube AI Hub, Kubernetes, Jobs, CronJobs"
description: "Learn basic concepts of CronJobs and how to create CronJobs on Kube AI Hub."
linkTitle: "CronJobs"
weight: 10260
---
...
- **Schedule**: It runs a Job periodically on a given time-based schedule. Please see [CRON](https://en.wikipedia.org/wiki/Cron) for grammar reference. Some preset CRON statements are provided in Kube AI Hub to simplify the input. This field is specified by `.spec.schedule`. For this CronJob, enter `*/1 * * * *`, which means it runs once per minute.
...
2. Scroll down to **Start Command** and enter `/bin/sh,-c,date; echo "Kube AI Hub!"` in the box under **Parameters**. 

3. Click **√** to finish setting the image and **Next** to continue.

    {{< notice note >}}

- This example CronJob prints `Kube AI Hub`. For more information about setting images, see [Pod Settings](../container-image-settings/).

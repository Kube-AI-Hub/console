---
title: "ConfigMaps"
keywords: 'Kube AI Hub, Kubernetes, ConfigMaps'
description: 'Learn how to create a ConfigMap in Kube AI Hub.'
...
This tutorial demonstrates how to create a ConfigMap in Kube AI Hub.
...
You can see the ConfigMap manifest file in YAML format by enabling **Edit YAML** in the upper-right corner. Kube AI Hub allows you to edit the manifest file directly to create a ConfigMap. Alternatively, you can follow the steps below to create a ConfigMap via the dashboard.
...
- On the Kube AI Hub dashboard, you can only add key-value pairs for a ConfigMap currently. In future releases, you will be able to add a path to a directory containing configuration files to create ConfigMaps directly on the dashboard.

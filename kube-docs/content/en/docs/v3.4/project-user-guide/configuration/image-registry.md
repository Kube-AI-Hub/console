...
keywords: 'Kube AI Hub, Kubernetes, docker, Secrets'
description: 'Learn how to create an image registry on Kube AI Hub.'
...
Log in to the web console of Kube AI Hub as `project-regular`. Go to **Configuration** of a project, select **Secrets** and click **Create**.

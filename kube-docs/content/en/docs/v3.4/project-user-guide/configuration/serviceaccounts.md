...
keywords: 'Kube AI Hub, Kubernetes, Service Accounts'
description: 'Learn how to create service accounts on Kube AI Hub.'
...
This document describes how to create service accounts on Kube AI Hub.
...
1. Log in to the Kube AI Hub console as `project-regular`, and click **Projects**. 

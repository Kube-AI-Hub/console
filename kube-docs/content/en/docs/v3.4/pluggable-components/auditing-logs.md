---
title: "Kube AI Hub Audit Logs"
keywords: "Kubernetes, auditing, Kube AI Hub, logs"
description: "Learn how to enable Auditing to document platform events and activities."
linkTitle: "Kube AI Hub Audit Logs"
weight: 6700
---
...
As you [install Kube AI Hub on Kubernetes](../../installing-on-kubernetes/introduction/overview/), you can enable Kube AI Hub Auditing first in the [cluster-configuration.yaml](https://github.com/kubesphere/ks-installer/releases/download/v3.4.1/cluster-configuration.yaml) file.

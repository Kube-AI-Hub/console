...
keywords: 'Kube AI Hub, Kubernetes, Bookinfo, Istio'
description: 'Explore the basics of Kube AI Hub service mesh by deploying an example application Bookinfo.'
...
To provide consistent user experiences of managing microservices, Kube AI Hub integrates Istio on the container platform. This tutorial demonstrates how to deploy a sample application Bookinfo composed of four separate microservices and access it through a NodePort.

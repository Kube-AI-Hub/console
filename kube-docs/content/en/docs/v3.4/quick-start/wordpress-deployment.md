...
keywords: 'Kube AI Hub, Kubernetes, app, WordPress'
description: 'Learn the entire process of deploying an example application in Kube AI Hub, including credential creation, volume creation, and component settings.'
...
This tutorial demonstrates how to create an application (WordPress as an example) in Kube AI Hub and access it outside the cluster.
...
1. Log in to the Kube AI Hub console using the account `project-regular`. Go to the detail page of `demo-project` and navigate to **Configuration**. In **Secrets**, click **Create** on the right.

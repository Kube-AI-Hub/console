...
Kube AI Hub supports managing the following three types of configuration resources:
...
* Service Account: Stores access information for the current Kube AI Hub cluster, used to provide access to the Kube AI Hub cluster for applications.

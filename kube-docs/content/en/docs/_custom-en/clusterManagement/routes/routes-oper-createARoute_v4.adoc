...
|
After installing the "Kube AI Hub Gateway" extension and enabling the cluster gateway, workspace gateway, or project gateway, you need to select the corresponding IngressClassName in the **Advanced Settings** tab when creating an Ingress.
|===

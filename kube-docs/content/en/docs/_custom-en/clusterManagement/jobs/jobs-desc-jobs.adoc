...
In Kube AI Hub, applications run in pods. Jobs are used to manage pods that run either once or periodically. Kube AI Hub supports the following types of jobs:

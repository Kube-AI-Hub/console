...
| Schedule
| The CRON expression specifying the runtime cycle for a CronJob. Kube AI Hub defaults to UTC time, and you may need to adjust it based on your time zone. Available only for CronJobs.

...
Service accounts are special accounts provided by Kube AI Hub for applications. Applications, whether internal or external to the cluster, can use service accounts to access the Kube AI Hub's API server.
...
- Service accounts cannot be used to log in to the Kube AI Hub web console.

...
|
The kubeconfig information contains the authentication details for the service account. You need to configure this kubeconfig information in your application to enable access to the Kube AI Hub cluster. For more information, refer to the link:https://kubernetes.io/zh/docs/concepts/configuration/organize-cluster-access-kubeconfig/[Kubernetes Documentation].
|===
--
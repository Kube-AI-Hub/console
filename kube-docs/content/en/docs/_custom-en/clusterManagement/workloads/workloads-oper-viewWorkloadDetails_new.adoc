...
+
--
* Click a revision record from the dropdown list to view its serial number, creation time, and configuration file. Kube AI Hub automatically creates a serial number for each revision record, and up to 10 revision records can be retained.

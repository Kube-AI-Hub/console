...
+
--
The monitoring and alerting module of Kube AI Hub will access the service and collect the application's monitoring metrics based on the parameters set here.

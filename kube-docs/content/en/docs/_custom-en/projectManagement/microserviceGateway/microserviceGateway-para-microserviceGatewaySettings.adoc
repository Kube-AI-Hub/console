...
+
--
Set whether to allow the microservice gateway to be accessed from outside the Kube AI Hub cluster. If external access is enabled, you need to select the external access mode.

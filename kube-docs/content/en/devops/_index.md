---
title: "DevOps With Kubernetes And Kube AI Hub"
description: Kube AI Hub DevOps offers powerful CI/CD features with excellent scalability and observability on top of Kubernetes for DevOps-oriented teams.
...
section1:
  title: "Kube AI Hub DevOps: A Powerful CI/CD Platform Built on Top of Kubernetes for DevOps-oriented Teams."
  content: Kube AI Hub DevOps integrates popular CI/CD tools, provides CI/CD pipelines based on Jenkins, offers automation toolkits including Binary-to-Image (B2I) and Source-to-Image (S2I), and boosts continuous delivery across Kubernetes clusters.
  content2: With the container orchestration capability of Kubernetes, Kube AI Hub DevOps scales Jenkins Agents dynamically, improves CI/CD workflow efficiency, and helps organizations accelerate the time to market for products.
  ...
  list:
    - title: Out-of-the-Box CI/CD Pipelines
      ...
      contentList:
        ...
        - content: <span>Easy SonarQube Integration</span> to implement source code quality analysis and view results on the Kube AI Hub console
    ...
    - title: Use Jenkins Pipelines to Implement DevOps on Top of Kubernetes
      ...
      contentList:
        ...
        - content: <span>Efficient DevOps teamwork</span> through the Kube AI Hub multi-tenant system on the basis of Kubernetes RBAC to achieve better access control in CI/CD workflows
...
section3:
  title: See Kube AI Hub One-stop DevOps Workflow In Action

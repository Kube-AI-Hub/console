...
section1:
  title: Kubernetes Observability in Kube AI Hub Allows You to Build Visualizations Simply and Intuitively.
  content: Kube AI Hub provides rich observability from infrastructure to applications. It integrates your favorite tools for multi-dimensional monitoring metrics, multi-tenant log query and collection, alerting and notification. Try Kubernetes Observability in Kube AI Hub to realize visualization in a simple way.
...
section3:
  title: See Kubernetes and Microservices Observability on Kube AI Hub

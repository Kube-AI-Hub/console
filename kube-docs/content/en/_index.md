---
title: Open Source Enterprise Kubernetes Platform | Kube AI Hub
...
section4:
  ...
  content: If you are seeking an open source project that rivals a commercial product, Kube AI Hub is your choice. <br> <br>The <a class='inner-a' target='_blank' href='https://github.com/kubesphere/kubesphere/blob/master/docs/roadmap.md'>RoadMap</a> lists the planned features and everyone is welcome to raise a proposal and contribute your ideas.
  children:
  ...
  features:
    ...
    - name: Edge Computing Platform
      ...
      content: Kube AI Hub integrates <a class='inner-a' target='_blank' href='https://kubeedge.io/en/'>KubeEdge</a> to enable users to deploy applications on the edge devices and view logging and monitoring data of them on the console.
...
section5:
  title: Kube AI Hub Container Platform with its Cloud Native Architecture
  frontEnd:
    title: Front End

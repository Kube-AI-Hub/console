...
section1:
  title: Kubernetes Service Mesh in Kube AI Hub Provides a Simpler Distribution of Istio with Consolidated UX.
...
section2:
  title: What Makes Kubernetes Service Mesh in Kube AI Hub Special
  list:
    ...
    - title: Kubernetes Microservices Visualization
      ...
      summary: Observability is extremely useful in understanding cloud-native microservice interconnections. Kube AI Hub has the ability to visualize the connections between microservices and the topology of how they interconnect.
      contentList:

    - title: Distributed Tracing for Kubernetes
      image: /images/service-mesh/distributed-tracing.png
      summary: Based on Jaeger, Kube AI Hub enables users to track how each Service interacts with each other. It brings a deeper understanding about request latency, bottlenecks, serialization and parallelism via visualization.
      contentList:

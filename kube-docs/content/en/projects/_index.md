---
title: "Open Source Community - Projects | Kube AI Hub"
description: Kube AI Hub is an open source container platform based on Kubernetes for enterprise app development and deployment, suppors installing anywhere from on-premise datacenter to any cloud to edge.
keywords: Kube AI Hub, Kubernetes Dashboard,  Install Enterprise Kubernetes, DevOps, Istio, Service Mesh, Jenkins, container platform
  ...
  - name: Container Platform
    children:
      - title: "Kube AI Hub"
        ...
        description: Kube AI Hub is a distributed operating system managing cloud native applications with Kubernetes as its kernel, and provides plug-and-play architecture for the seamless integration of third-party applications to boost its ecosystem.
  ...
  - name: Installer
    children:
      - title: KubeKey
        ...
        description: KubeKey is the next-gen installer for Kubernetes and Kube AI Hub. KubeKey changes from ansible-based technology to Go, supports installing Kubernetes and Kube AI Hub separately or as a whole easily, efficiently and flexibly.
  ...
  - name: Design
    children:
      - title: kube-design
        ...
        description: Kube Design is a set of React component libraries created for Kube AI Hub console. If you want to develop Kube AI Hub console, this library will be pretty useful in customizing front end.

  ...
  - name: 服务代理
    children:
      - title: OpenELB 负载均衡器
        ...
        description: CNCF 沙箱项目，此前命名为 PorterLB，是为物理机（Bare-metal）、边缘（Edge）和私有化环境设计的负载均衡器插件，可作为 Kubernetes、K3s、Kube AI Hub 的 LB 插件对集群外暴露 "LoadBalancer" 类型的服务。
  ...
  - name: 安装部署
    children:
      - title: KubeKey
        ...
        description: KubeKey 是 Kubernetes 和 Kube AI Hub 的下一代 Installer（安装程序），旨在更方便、快速、高效和灵活地安装 Kubernetes 与 Kube AI Hub。KubeKey 摒弃了原来 Ansible 带来的依赖问题，用 Go 重写，支持单独 Kubernetes 或整体安装 Kube AI Hub。
  ...
  - name: 告警系统
    children:
      - title: Alerting System
        ...
        description: Kube AI Hub Alert 是一种企业级的通用高性能报警系统。
  ...
  - name: 前端设计
    children:
      - title: kube-design
        ...
        description: kube-design 是为 Kube AI Hub Console 前端创建的一组 React 组件库。如果您想开发与扩展 Kube AI Hub 控制台（Console）的前端，这个库在定制 Kube AI Hub 前端时会非常有用。

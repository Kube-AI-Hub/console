---
title: "在 AWS EKS 上部署 Kube AI Hub"
keywords: 'Kubernetes, Kube AI Hub, EKS, 安装'
description: '了解如何在 Amazon Elastic Kubernetes Service 上部署 Kube AI Hub。'

weight: 4220
---

本指南将介绍如何在 [AWS EKS](https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html) 上部署 Kube AI Hub。您也可以通过 [Kube AI Hub on AWS Quick Start](https://aws.amazon.com/quickstart/architecture/qingcloud-kubesphere/) 在 AWS 上自动部署 EKS 和 Kube AI Hub。
...
1. 在 AWS 上创建一个标准的 Kubernetes 集群是安装 Kube AI Hub 的前提条件，转到导航菜单，然后参考下图创建集群。
...
- 使用 EKS 生成的 external-ip 访问 Kube AI Hub 的 Web 控制台。

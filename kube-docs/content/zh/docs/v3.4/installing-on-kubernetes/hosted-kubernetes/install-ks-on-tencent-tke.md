...
本指南将介绍如何在[腾讯云 TKE](https://cloud.tencent.com/document/product/457/6759) 上部署并使用 Kube AI Hub 3.4 平台。
...
接下来就可以使用 [ks-installer](https://github.com/kubesphere/ks-installer) 在已有的 Kubernetes 集群上来执行 Kube AI Hub 部署，建议首先还是以最小功能集进行安装。
...
部署完成后，您可以通过以下步骤访问 Kube AI Hub 控制台。
...
### 通过 Kube AI Hub 开启附加组件
以上示例演示了默认的最小安装过程，要在 Kube AI Hub 中启用其他组件，请参阅[启用可插拔组件](../../../pluggable-components/)。

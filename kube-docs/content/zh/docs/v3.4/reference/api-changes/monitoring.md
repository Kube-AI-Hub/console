---
title: "监控系统"
keywords: 'Kubernetes, Kube AI Hub, API, 监控系统'
description: 'Kube AI Hub 3.4 中监控系统（服务组件）的 API 变更。'
linkTitle: "监控系统"
weight: 17320
---
...
在 Kube AI Hub 3.4 中，下表左侧的指标已重命名为右侧的指标。
...
在 Kube AI Hub 3.4 中，已移除响应字段 `metrics_level`、`status` 和 `errorType`。

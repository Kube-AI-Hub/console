---
title: "使用 KubeKey 升级"
keywords: "Kubernetes, 升级, Kube AI Hub, 3.4, KubeKey"
description: "使用 KubeKey 升级 Kubernetes 和 Kube AI Hub。"
linkTitle: "使用 KubeKey 升级"
weight: 7200
---

对于 Kube AI Hub 和 Kubernetes 都由 [KubeKey](../../installing-on-linux/introduction/kubekey/) 部署的用户，推荐使用 KubeKey 升级。如果您的 Kubernetes 集群由云厂商托管或自行配置，请参考[使用 ks-installer 升级](../upgrade-with-ks-installer/)。
...
- 您需要有一个运行 Kube AI Hub v3.3.x 的集群。如果您的 Kube AI Hub 是 v3.2.x 或更早的版本，请先升级至 v3.3.x。

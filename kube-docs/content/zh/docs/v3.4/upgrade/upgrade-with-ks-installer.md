...
description: "使用 ks-installer 升级 Kube AI Hub。"
linkTitle: "使用 ks-installer 升级"
weight: 7300
---

对于 Kubernetes 集群不是通过 [KubeKey](../../installing-on-linux/introduction/kubekey/) 部署而是由云厂商托管或自行搭建的用户，推荐使用 ks-installer 升级。本教程**仅用于升级 Kube AI Hub**。集群运维员应负责提前升级 Kubernetes。
...
您可以在升级后启用 Kube AI Hub 3.4 的[可插拔组件](../../pluggable-components/overview/)以体验该容器平台的更多功能。
---
title: "接收和自定义审计日志"
keywords: "Kubernetes, Kube AI Hub, 审计, 日志, 自定义, 接收"
...
要启用审计日志，请参见 [Kube AI Hub 审计日志](../../../pluggable-components/auditing-logs/)。
...
将 `auditing.enabled` 的值修改为 `false`，停止接收来自 Kube AI Hub 的审计日志。

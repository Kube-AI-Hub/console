---
title: "查看资源消费"
keywords: "Kubernetes, Kube AI Hub, 计量, 计费, 消费"
description: "在不同层级追踪集群工作负载的资源用量。"
linkTitle: "查看资源消费"
weight: 15410
---

Kube AI Hub 计量功能帮助您在不同层级追踪集群或企业空间中的资源消费。具有不同角色的租户只能看到其有权访问的数据。此外，您还可以为不同的资源设置价格以查看计费信息。

## 准备工作 

- 所有租户都可以访问**资源消费统计**模块，但每个租户可见的信息可能有所不同，可见信息具体取决于租户在所处层级上具有的角色。请注意，计量功能并非 Kube AI Hub 的可插拔组件，即只要您有一个 Kube AI Hub 集群，就可以使用该功能。对于新创建的集群，您需要等待大约一小时才能看到计量信息。
...
1. 使用 `admin` 用户登录 Kube AI Hub Web 控制台，点击右下角的 <img src="/images/docs/v3.x/zh-cn/toolbox/metering-and-billing/view-resource-consumption/toolbox.png" width='20px' alt="icon" />，然后选择**资源消费统计**。
...
1. 使用 `admin` 用户登录 Kube AI Hub Web 控制台，点击右下角的 <img src="/images/docs/v3.x/zh-cn/toolbox/metering-and-billing/view-resource-consumption/toolbox.png" width='20' alt="icon" /> 图标，然后选择**资源消费统计**。

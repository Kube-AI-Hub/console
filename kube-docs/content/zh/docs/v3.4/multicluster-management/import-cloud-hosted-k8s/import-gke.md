...
keywords: 'Kubernetes, Kube AI Hub, 多集群, Google GKE'
...
- 您需要准备一个已安装 Kube AI Hub 的 Kubernetes 集群，并将该集群设置为主集群。有关如何准备主集群的更多信息，请参考[准备主集群](../../../multicluster-management/enable-multicluster/direct-connection/#准备-host-集群)。
- 您需要准备一个 GKE 集群，用作成员集群。

## 导入 GKE 集群

### 步骤 1：在 GKE 集群上部署 Kube AI Hub

您需要首先在 GKE 集群上部署 Kube AI Hub。有关如何在 GKE 上部署 Kube AI Hub 的更多信息，请参考[在 Google GKE 上部署 Kube AI Hub](../../../installing-on-kubernetes/hosted-kubernetes/install-kubesphere-on-gke/)。
...
2. 以 `admin` 身份登录 GKE 的 Kube AI Hub Web 控制台。点击左上角的**平台管理**，选择**集群管理**。
...
1. 以 `admin` 身份登录主集群的 Kube AI Hub Web 控制台。点击左上角的**平台管理**，选择**集群管理**。在**集群管理**页面，点击**添加集群**。

---
title: "导入阿里云 ACK 集群"
keywords: 'Kubernetes, Kube AI Hub, 多集群, 阿里云 ACK'
...
- 您需要准备已安装 Kube AI Hub 的 Kubernetes 集群，并将该集群设置为主集群。有关如何准备主集群的更多信息，请参考[准备主集群](../../../multicluster-management/enable-multicluster/direct-connection/#准备-host-集群)。
- 您需要准备已安装 Kube AI Hub 的 ACK 集群，用作成员集群。
...
2. 以 `admin` 身份登录 ACK 集群的 Kube AI Hub 控制台。点击左上角的**平台管理**，选择**集群管理**。

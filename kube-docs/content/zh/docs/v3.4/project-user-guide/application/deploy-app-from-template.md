---
title: "从应用模板部署应用"
keywords: 'Kubernetes, Chart, Helm, Kube AI Hub, 应用程序, 应用模板'
...
部署应用时，您可选择使用应用商店。应用商店包含了 Kube AI Hub 的内置应用和[以 Helm Chart 形式上传的应用](../../../workspace-administration/upload-helm-based-application/)。此外，您还可以使用应用模板。应用模板可由添加至 Kube AI Hub 的私有应用仓库提供。
...
1. 登出 Kube AI Hub 并以 `project-regular` 用户重新登录。在您的项目中，进入**应用负载**下的**应用**页面，再点击**创建**。

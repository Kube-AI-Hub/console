---
title: "从应用商店部署应用"
keywords: 'Kubernetes, Chart, Helm, Kube AI Hub, 应用, 应用商店'
...
本教程演示如何从基于 [OpenPitrix](https://github.com/openpitrix/openpitrix) 的 Kube AI Hub 应用商店快速部署 [NGINX](https://www.nginx.com/)，并通过 NodePort 访问其服务。
...
1. 以 `project-regular` 身份登录 Kube AI Hub Web 控制台，点击左上角的**应用商店**。

---
title: "蓝绿部署"
keywords: 'Kube AI Hub, Kubernetes, 服务网格, istio, 发布, 蓝绿部署'
description: '了解如何在 Kube AI Hub 中发布蓝绿部署。'
...
![blue-green-0](/images/docs/v3.x/project-user-guide/grayscale-release/blue-green-deployment/blue-green-0-zh.svg)
...
1. 以 `project-regular` 身份登录 Kube AI Hub，前往**灰度发布**页面，在**发布模式**选项卡下，点击**蓝绿部署**右侧的**创建**。
...
9. 您可以执行以下命令直接获取虚拟服务来查看权重：
   ...
   - 如果您想使用 Kube AI Hub 控制台上的 Web Kubectl 来执行命令，则需要使用 `admin` 帐户。

---
title: "流量镜像"
keywords: 'Kube AI Hub, Kubernetes, 流量镜像, Istio'
description: '了解如何在 Kube AI Hub 中执行流量镜像任务。'
linkTitle: "流量镜像"
weight: 10540
---
...
- 您需要启用 [Kube AI Hub 服务网络](../../../pluggable-components/service-mesh/)。
...
1. 以 `project-regular` 用户登录 Kube AI Hub 并进入项目。前往**灰度发布**页面，在页面右侧点击**流量镜像**右侧的**创建**。
...
9. 您可以执行以下命令查看虚拟服务的 `mirror` 和 `weight` 字段。
   ...
   - 您需要以 `admin` 用户重新登录才能在 Kube AI Hub 控制台的 Web kubectl 页面执行上述命令。

---
title: "金丝雀发布"
keywords: 'Kube AI Hub, Kubernetes, 金丝雀发布, istio, 服务网格'
description: '了解如何在 Kube AI Hub 中部署金丝雀服务。'
linkTitle: "金丝雀发布"
weight: 10530
---

Kube AI Hub 基于 [Istio](https://istio.io/) 向用户提供部署金丝雀服务所需的控制功能。在金丝雀发布中，您可以引入服务的新版本，并向其发送一小部分流量来进行测试。同时，旧版本负责处理其余的流量。如果一切顺利，您就可以逐渐增加向新版本发送的流量，同时逐步停用旧版本。如果出现任何问题，您可以用 Kube AI Hub 更改流量比例来回滚至先前版本。
...
<video controls="controls" style="width: 100% !important; height: auto !important;">
  <source type="video/mp4" src="https://kubesphere-community.pek3b.qingstor.com/videos/Kube AI Hub-v3.1.x-tutorial-videos/zh/KS311_200P005C202109_%E9%87%91%E4%B8%9D%E9%9B%80%E5%8F%91%E5%B8%83%E5%AE%9E%E8%B7%B5.mp4">
</video>
...
1. 以 `project-regular` 身份登录 Kube AI Hub 控制台，转到**灰度发布**页面，在**发布模式**选项卡下，点击**金丝雀发布**右侧的**创建**。
...
- 如果您想在 Kube AI Hub 控制台使用 Web kubectl 执行命令，则需要使用 `admin` 帐户登录。
...
1. 在运行 Kube AI Hub 的机器上执行以下命令引入真实流量，每 0.5 秒模拟访问一次 Bookinfo。
...
Kube AI Hub 提供基于 [Jaeger](https://www.jaegertracing.io/) 的分布式追踪功能，用来对基于微服务的分布式应用程序进行监控及故障排查。

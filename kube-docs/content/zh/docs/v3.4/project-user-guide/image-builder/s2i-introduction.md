...
有关如何在 Kube AI Hub 中使用 S2I 的更多信息，请参考 [Source to Image：无需 Dockerfile 发布应用](../source-to-image/)。此外，您还可以参考代码仓库 [S2IOperator](https://github.com/kubesphere/s2ioperator#source-to-image-operator) 和 [S2IRun](https://github.com/kubesphere/s2irun#s2irun) 查看更多详细信息。
...
![s2i-builder](/images/docs/v3.x/project-user-guide/image-builder/s2i-intro/s2i-builder-zh.svg)
...
![s2i-flow](/images/docs/v3.x/project-user-guide/image-builder/s2i-intro/s2i-flow-zh.svg)
...
![s2i-runtime-build](/images/docs/v3.x/project-user-guide/image-builder/s2i-intro/s2i-runtime-build-zh.svg)
---
title: "配置字典"
keywords: 'Kube AI Hub, Kubernetes, ConfigMap'
description: '了解如何在 Kube AI Hub 中创建配置字典。'
linkTitle: "配置字典"
weight: 10420
---
...
- 目前 Kube AI Hub 控制台只支持在配置字典中配置键值对。未来版本将会支持添加配置文件的路径来创建配置字典。

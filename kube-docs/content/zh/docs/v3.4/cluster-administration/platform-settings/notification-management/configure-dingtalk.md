---
title: "配置钉钉通知"
keywords: 'Kube AI Hub, Kubernetes, 钉钉, 通知, 告警'
...
### 步骤 4：在 Kube AI Hub 控制台配置钉钉通知

您必须在 Kube AI Hub 控制台提供钉钉的通知设置，以便 Kube AI Hub 将通知发送至您的钉钉。
...
配置钉钉通知并添加会话或群机器人后，您需要启用 [Kube AI Hub 告警系统](../../../../pluggable-components/alerting/)，并为[工作负载](../../../../project-user-guide/alerting/alerting-policy/)或[节点](../../../cluster-wide-alerting-and-notification/alerting-policy/)创建告警策略。告警触发后，您的钉钉将收到通知消息。
...
- 如果您更新了钉钉通知配置，Kube AI Hub 将根据最新配置发送通知。
...
- Kube AI Hub 设有内置告警策略，在不设置任何自定义告警策略的情况下，只要内置告警策略被触发，您的钉钉仍能接收通知消息。

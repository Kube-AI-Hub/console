---
title: "配置邮件通知"
keywords: 'Kube AI Hub, Kubernetes, 自定义, 平台'
...
配置邮件通知并添加接收人后，您需要启用 [Kube AI Hub 告警](../../../../pluggable-components/alerting/)，并为工作负载或节点创建告警策略。告警触发后，所有接收人都将能收到邮件通知。

{{< notice note >}}

- 如果您更新了邮件服务器配置，Kube AI Hub 将根据最新配置发送邮件通知。
...
- Kube AI Hub 拥有内置告警策略，在不设置任何自定义告警策略的情况下，只要内置告警策略被触发，您的接收人仍能收到邮件通知。

---
title: "在 Hostinger VPS 上安装使用 Kube AI Hub"
keywords: "Kube AI Hub, 安装, Hostinger, VPS"
description: "了解如何使用 Kube AI Hub VPS 模板。"
linkTitle: "在 Hostinger VPS 上安装使用 Kube AI Hub"
Weight: 3450
---
...
目前 Hostinger 提供预安装的 Kube AI Hub 的 Ubuntu 22.04 VPS 模板。通过安装该模板，即可在 Hostinger VPS 上使用 Kube AI Hub。

## 如何使用 Kube AI Hub VPS 模板

现在，您可以在 Hostinger 平台上，一键部署包含了 Kube AI Hub 的 VPS，而无需额外在 VPS 手工部署了，极大的简化了您的运维工作，具体步骤请参考 [Hostinger Kube AI Hub VPS 相关文档](https://support.hostinger.com/en/articles/8687660-how-to-use-the-kubesphere-vps-template)。
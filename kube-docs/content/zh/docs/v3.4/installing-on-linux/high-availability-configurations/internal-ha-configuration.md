...
keywords: 'Kube AI Hub, Kubernetes, KubeKey, 高可用, 安装'
description: '如何使用 KubeKey 内置的 HAproxy 安装一个高可用的 Kube AI Hub 与 Kubernetes 集群。'
...
本教程演示了在 Linux 上安装 Kube AI Hub 时，使用 KubeKey 内置高可用模式部署的大体配置。

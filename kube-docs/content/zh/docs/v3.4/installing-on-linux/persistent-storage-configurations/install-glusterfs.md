---
title: "安装 GlusterFS"
keywords: 'Kube AI Hub, Kubernetes, GlusterFS, 安装, 配置, 存储'
description: '使用 KubeKey 搭建 Kube AI Hub 集群并配置 GlusterFS 存储。'
...
本教程演示了如何使用 KubeKey 搭建 Kube AI Hub 集群并配置 GlusterFS 以提供存储服务。
...
1. 指定想要安装的 Kubernetes 版本和 Kube AI Hub 版本，例如：
...
您可以使用命令行或者在 Kube AI Hub 的 Web 控制台验证 GlusterFS 是否成功安装。

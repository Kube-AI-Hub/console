---
title: "离线安装"
keywords: '离线, 安装, Kube AI Hub'
description: '了解如何在离线环境下安装 Kube AI Hub 和 Kubernetes。'

linkTitle: "离线安装"
weight: 3130
---

KubeKey 是一个用于部署 Kubernetes 集群的开源轻量级工具。它提供了一种灵活、快速、便捷的方式来仅安装 Kubernetes/K3s，或同时安装 Kubernetes/K3s 和 Kube AI Hub，以及其他云原生插件。除此之外，它也是扩展和升级集群的有效工具。
...
9. 通过 `http://{IP}:30880` 使用默认帐户和密码 `admin/P@88w0rd` 访问 Kube AI Hub 的 Web 控制台。

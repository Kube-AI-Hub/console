...
keywords: "Kubernetes, Kube AI Hub, 多集群, 主集群, 成员集群"
description: "了解如何恢复主集群对成员集群的访问。"
linkTitle: "恢复主集群对成员集群的访问权限"
Weight: 16720
---

[多集群管理](../../../multicluster-management/introduction/kubefed-in-kubesphere/)是 Kube AI Hub 的一大特色，拥有必要权限的租户（通常是集群管理员）能够从主集群访问中央控制平面，以管理全部成员集群。强烈建议您通过主集群管理整个集群的资源。

本教程演示如何恢复主集群对成员集群的访问权限。

## 可能出现的错误信息

如果您无法从中央控制平面访问成员集群，并且浏览器一直将您重新定向到 Kube AI Hub 的登录页面，请在该成员集群上运行以下命令来获取 ks-apiserver 的日志。

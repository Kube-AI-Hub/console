---
title: "移除 Kube AI Hub 中的内置应用"
keywords: "Kube AI Hub, OpenPitrix, 应用程序, 应用"
description: "了解如何下架 Kube AI Hub 中的内置应用。"
linkTitle: "移除 Kube AI Hub 中的内置应用"
Weight: 16910
---
...
5. 若要让该应用在应用商店中再次可用，请点击**上架应用**，然后点击**确定**以确认您的操作。
   ...
   您也可以根据自己的需要，来创建包含必须角色的新用户。有关更多在 Kube AI Hub 中管理应用的信息，请参考[应用程序生命周期管理](../../../application-store/app-lifecycle-management/)。

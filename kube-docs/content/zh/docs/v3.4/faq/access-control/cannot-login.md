---
title: "用户无法登录"
keywords: "无法登录, 用户不活跃, Kube AI Hub, Kubernetes"
description: "如何解决无法登录的问题"
linkTitle: "用户无法登录"
Weight: 16440
---

Kube AI Hub 安装时会自动创建默认用户 (`admin/P@88w0rd`)，密码错误或者用户状态不是**活跃**会导致无法登录。

下面是用户无法登录时，一些常见的问题：

## Account Not Active

登录失败时，登录页通常会提示用户未激活。请根据以下步骤排查并解决问题：

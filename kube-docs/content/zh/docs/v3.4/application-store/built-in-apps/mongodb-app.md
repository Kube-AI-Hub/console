---
title: "在 Kube AI Hub 中部署 MongoDB"
keywords: 'Kube AI Hub, Kubernetes, 安装, MongoDB'
description: '了解如何从 Kube AI Hub 应用商店中部署 MongoDB 并访问服务。'
linkTitle: "在 Kube AI Hub 中部署 MongoDB"
weight: 14250
---

[MongoDB](https://www.mongodb.com/) 是一个通用的、基于文档的分布式数据库，为现代应用开发者和云时代而打造。

本教程演示如何从 Kube AI Hub 应用商店部署 MongoDB。

---
title: "在 Kube AI Hub 中部署 PostgreSQL"
keywords: 'Kubernetes, Kube AI Hub, PostgreSQL, 应用商店'
description: '了解如何从 Kube AI Hub 应用商店中部署 PostgreSQL 并访问服务。'
linkTitle: "在 Kube AI Hub 中部署 PostgreSQL"
weight: 14280  
---

作为强大的开源对象关系型数据库系统，[PostgreSQL](https://www.postgresql.org/) 以其卓越的可靠性、功能鲁棒性和高性能而著称。

本教程演示如何从 Kube AI Hub 的应用商店部署 PostgreSQL。

---
title: "在 Kube AI Hub 中部署 NGINX"
keywords: 'Kube AI Hub, Kubernetes, 安装, NGINX'
description: '了解如何从 Kube AI Hub 应用商店中部署 NGINX 并访问服务。'
linkTitle: "在 Kube AI Hub 中部署 NGINX"
weight: 14270
---

[NGINX](https://www.nginx.com/) 是一个开源软件应用，用于 Web 服务、反向代理、缓存、负载均衡、流媒体等。

本教程演示如何从 Kube AI Hub 应用商店部署 NGINX。

---
title: "在 Kube AI Hub 中部署 MinIO"
keywords: 'Kubernetes, Kube AI Hub, Minio, 应用商店'
description: '了解如何从 Kube AI Hub 应用商店中部署 Minio 并访问服务。'
linkTitle: "在 Kube AI Hub 中部署 MinIO"
weight: 14240
---
[MinIO](https://min.io/) 对象存储为高性能和 S3 API 而设计。对于具有严格安全要求的大型私有云环境来说，MinIO 是理想选择，它可以为多种工作负载提供任务关键型可用性。

本教程演示如何从 Kube AI Hub 应用商店部署 MinIO。

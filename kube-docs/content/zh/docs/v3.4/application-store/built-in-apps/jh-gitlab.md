---
title: "在 Kube AI Hub 上部署极狐GitLab"
keywords: 'Kube AI Hub, Kubernetes, 极狐GitLab, DevOps'
description: '了解并掌握如何在 Kube AI Hub 中部署和使用极狐GitLab'
...
9. 如果需要调试，可以利用 Kube AI Hub 的小工具（下图右下角红色方框所示的小锤子）来查看安装的极狐GitLab实例所对应的 Kubernetes 资源：

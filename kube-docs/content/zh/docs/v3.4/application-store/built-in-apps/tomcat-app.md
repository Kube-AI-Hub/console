---
title: "在 Kube AI Hub 中部署 Tomcat"
keywords: 'Kube AI Hub, Kubernetes, 安装, Tomcat'
description: '了解如何从 Kube AI Hub 应用商店中部署 Tomcat 并访问服务。'

link title: "在 Kube AI Hub 中部署 Tomcat"
weight: 14292
---
[Apache Tomcat](https://tomcat.apache.org/index.html) 支撑着诸多行业和组织中的众多大规模任务关键型 Web 应用。它提供了一个纯 Java HTTP Web 服务器环境，可用于执行 Java 代码。

本教程演示如何从 Kube AI Hub 的应用商店部署 Tomcat。

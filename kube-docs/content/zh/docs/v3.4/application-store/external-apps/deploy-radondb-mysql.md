---
title: "在 Kube AI Hub 中部署 RadonDB MySQL Operator 和 RadonDB MySQL 集群"
keywords: 'Kube AI Hub, Kubernetes, 安装, RadonDB MySQL'
description: '了解如何从 Kube AI Hub 应用商店部署 RadonDB MySQL。'
...
以下演示在 Kube AI Hub 访问 RadonDB MySQL 的方式，若需从集群外部访问 RadonDB MySQL，请参考 [RadonDB MySQL 开源项目](https://github.com/radondb/radondb-mysql-kubernetes/)。

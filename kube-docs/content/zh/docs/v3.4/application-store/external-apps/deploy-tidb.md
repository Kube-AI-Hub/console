---
title: "在 Kube AI Hub 中部署 TiDB Operator 和 TiDB 集群"
keywords: 'Kube AI Hub, Kubernetes, TiDB, TiDB Operator, TiDB 集群'
description: '了解如何在 Kube AI Hub 中部署 TiDB Operator 和 TiDB 集群。'
...
本教程演示了如何在 Kube AI Hub 上部署 TiDB Operator 和 TiDB 集群。
...
1. 以 `admin` 身份登录 Kube AI Hub 的 Web 控制台，使用右下角**工具箱**中的 **Kubectl** 执行以下命令来安装 TiDB Operator CRD：
...
3. 将仓库成功导入到 Kube AI Hub 之后，它将显示在列表中。


### 步骤 3：部署 TiDB Operator

1. 登出 Kube AI Hub，再以 `project-regular` 身份登录。在您的项目中，访问**应用负载**下的**应用**，点击**创建**。

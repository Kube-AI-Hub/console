---
title: "在 Kube AI Hub 上部署 GitLab"
keywords: 'Kube AI Hub, Kubernetes, GitLab, 应用商店'
description: '了解如何在 Kube AI Hub 中部署 GitLab 并访问服务。'
linkTitle: "在 Kube AI Hub 上部署 GitLab"
weight: 14310
---

[GitLab](https://about.gitlab.com/) 是一个端到端的开源软件开发平台，具有内置的版本控制、问题追踪、代码审查、CI/CD 等功能。

本教程演示了如何在 Kube AI Hub 上部署 GitLab。

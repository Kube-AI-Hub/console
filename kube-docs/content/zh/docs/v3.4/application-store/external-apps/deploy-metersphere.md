---
title: "在 Kube AI Hub 上部署 MeterSphere"
keywords: 'Kube AI Hub, Kubernetes, 应用程序, MeterSphere'
description: '了解如何在 Kube AI Hub 中部署 MeterSphere。'
linkTitle: "在 Kube AI Hub 上部署 MeterSphere"
weight: 14330
---

MeterSphere 是一站式的开源企业级连续测试平台，涵盖测试跟踪、界面测试和性能测试等功能。

本教程演示了如何在 Kube AI Hub 上部署 MeterSphere。
...
3. 仓库成功导入到 Kube AI Hub 后，会显示在列表里。


### 步骤 2：部署 MeterSphere

1. 登出 Kube AI Hub，再以 `project-regular` 登录。在您的项目中，访问**应用负载**下的**应用**，然后点击**创建**。

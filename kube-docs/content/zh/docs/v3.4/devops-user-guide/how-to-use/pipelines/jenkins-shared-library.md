...
keywords: 'Kube AI Hub, Kubernetes, Jenkins, 共享库, 流水线'
...
本教程演示如何在 Kube AI Hub DevOps 流水线中使用 Jenkins 共享库。

## 准备工作

- [启用 Kube AI Hub DevOps 系统](../../../../pluggable-components/devops/)。
...
1. 用 `project-regular` 帐户登录 Kube AI Hub web 控制台。进入 DevOps 项目并点击**流水线**页面上的**创建**。

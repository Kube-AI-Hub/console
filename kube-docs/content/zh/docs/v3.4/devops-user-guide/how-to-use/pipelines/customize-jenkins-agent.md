...
description: "了解如何在 Kube AI Hub 上自定义 Jenkins Agent。"
linkTitle: "自定义 Jenkins Agent"
Weight: 112191
---

如果您需要使用运行特定环境（例如 JDK 11）的 Jenkins Agent，您可以在 Kube AI Hub 上自定义 Jenkins Agent。

本文档描述如何在 Kube AI Hub 上自定义 Jenkins Agent。
...
1. 以 `admin` 用户登录 Kube AI Hub Web 控制台。

...
keywords: 'Kubernetes, Docker, Kube AI Hub, Jenkins, CICD, 流水线, 依赖项缓存'
...
本教程演示如何设置 CI 节点，以便 Kube AI Hub 将流水线的任务以及 S2I/B2I 构建的任务调度到这些节点。
...
3. 点击**保存**。Kube AI Hub 将根据您设置的污点调度任务。您现在可以回到 DevOps 流水线上进行操作。

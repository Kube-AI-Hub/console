---
title: "创建多集群流水线"
keywords: 'Kube AI Hub, Kubernetes, 多集群, 流水线, DevOps'
...
本教程将演示如何在 Kube AI Hub 创建一个多集群流水线。
...
这些 Kubernetes 集群可以被托管至不同的云厂商，也可以使用不同的 Kubernetes 版本。针对 Kube AI Hub 3.4 推荐的 Kubernetes 版本：v1.20.x、v1.21.x、v1.22.x、v1.23.x、* v1.24.x、* v1.25.x 和 * v1.26.x。带星号的版本可能出现边缘节点部分功能不可用的情况。因此，如需使用边缘节点，推荐安装 v1.23.x。

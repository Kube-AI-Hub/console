...
topSection:
  ...
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会，是由 Kube AI Hub 社区牵头发起，在某个城市当地，由活跃且愿意为 Kube AI Hub 社区发展而贡献的社区成员构成的组织。社区会给予委员会相应的支持和授权，汇聚城市当地优秀的云原生人才，连接 Kube AI Hub 社区与开发者，通过丰富多样化的社区交流与线下互动活动，促进云原生技术知识的分享、推广和实践，促进 Kube AI Hub 社区的发展。目前已经成立 5 个城市站：上海、杭州、成都、广州、深圳。
...
citySection:
  cityCard: 
    title: 城市站
    des: Kube AI Hub 用户委员会目前已经成立 5 个城市站：上海、杭州、成都、广州、深圳。
...
organization:
  ...
  description: Advocacy and Outreach SIG 是社区用户委员会的上级组织。该 SIG 从社区运营的角度让 Kube AI Hub 开源社区保持健康活跃、更好地服务社区用户，以创新的方式发展社区。在每个城市站下设立一名站长，一名副站长，数名委员。
...
applyNew:
  title_en: Kube AI Hub community
  title: 申请成立新的城市站
  description: 为了方便 Kube AI Hub 社区用户的线下交流，以及本地活动的开展，Kube AI Hub 社区欢迎并鼓励成立新的城市站（上海、杭州、成都、广州除外）。
  right_pic: /images/user-group/list/applyNew/apply.svg

  conditions: 
    text: 成立条件
    description: 
      - head: 1.要成立的城市站至少要有一名近半年内在 Kube AI Hub 社区中活跃的成员作为站长发起。
        link:
          text: 
          link_address:
        tail: 
      
      - head: 2.当地能够组织起来小规模（20 人以上）的技术交流活动（Kube AI Hub 相关）。

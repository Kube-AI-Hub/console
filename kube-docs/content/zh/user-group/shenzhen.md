...
topSection:
  ...
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会—深圳站，成立于 2023 年 4 月 8 日，是由活跃在深圳的 Kube AI Hub 社区用户和成员组成的。初创核心成员 5 人。
...
station:
  ...
  name: 
    ...
    text2: 社区用户委员会—深圳站
  description: 
    - 不管你是否是 Kube AI Hub 的用户，只要你对云原生技术感兴趣，对组织活动有热情，对发展 Kube AI Hub 社区有想法，即可申请加入 Kube AI Hub 社区深圳用户委员会。
    - 如果你想加入 Kube AI Hub 社区用户委员会—深圳站，成为其中的一名委员（成员），为发展 Kube AI Hub 社区贡献自己的一份力量，可添加深圳站站长微信申请，并可加入 Kube AI Hub 开源社区深圳站微信群。
  manager: 
    name: 徐鹏
...
activities:
  ...
  review:    
    - text: 好上好信息 API 微服务集群在 Kube AI Hub 的部署实践
      description: 这篇文章介绍了深圳好上好信息使用 Kube AI Hub 的最佳实践过程。
      link: https://kubesphere.io/zh/case/bobinfo/

    - text: 技研智联云原生容器化平台实践
      description: 这篇文章介绍了技研智联使用 Kube AI Hub 的最佳实践过程。
      link: https://kubesphere.io/zh/case/keyenlinx/

    - text: 文鼎创智能物联云原生容器化平台实践
      description: 这篇文章介绍了文鼎创使用 Kube AI Hub 的最佳实践过程。

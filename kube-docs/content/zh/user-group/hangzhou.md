...
topSection:
  kubSphere: Kube AI Hub 
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会—杭州站，成立于 2021 年 5 月 29 日，是由活跃在杭州的 Kube AI Hub 社区用户和成员组成的。初创核心成员 3 人。
  image: /images/user-group/hangzhou/banner.png
  mobile_image: /images/user-group/hangzhou/m-banner.png

station:
  name_en: Kube AI Hub Community
  name: 
    text1: 申请加入
    text2: 社区用户委员会—杭州站
  description: 
    - 不管你是否是 Kube AI Hub 的用户，只要你对云原生技术感兴趣，对组织活动有热情，对发展 Kube AI Hub 社区有想法，即可申请加入 Kube AI Hub 社区杭州用户委员会。
    - 如果你想加入 Kube AI Hub 社区用户委员会—杭州站，成为其中的一名委员（成员），为发展 Kube AI Hub 社区贡献自己的一份力量，可添加杭州站站长微信申请，并可加入 Kube AI Hub 开源社区杭州站微信群。
  manager: 
    name: 尹珉
...
returns:
  ...
  list:
    ...
    - text: Kube AI Hub 社区周边纪念礼品、社区认证证书及社区 Title
...
members:
  ...
  list:
    - name: 尹珉
      position: 站长
      des: 杭州微宏科技有限公司运维主管， Kube AI Hub 开源社区 Ambassador，云原生爱好者。
      image: /images/user-group/hangzhou/yinmin.jpeg

    - name: 薛兴林
      position: 副站长
      des: 运维负责人，Kube AI Hub 社区 Ambassador，开源爱好者，擅长 Linux 系统、网络、服务器、虚拟化、容器、微服务架构、中间件、监控、CI/CD 等运维工作
...
activities:
  ...
  review:
    ...
    - text: 揭秘！Kube AI Hub 背后的“超级大脑”：etcd 的魅力与力量
      description: 我们将深入探索 etcd 如何巧妙地融入 Kube AI Hub 生态系统，并通过实际应用场景展示其对提升平台工作效率和可靠性的关键作用。
      link: https://kubesphere.io/zh/blogs/kubesphere-etcd-guide/

    - text: 基于 Kube AI Hub 部署 KubeBlocks 实现数据库自由
      description: Kube AI Hub 让 KubeBlocks 更易部署和使用，KubeBlocks 让应用在 Kube AI Hub 上更灵活弹性。
      link: https://kubesphere.io/zh/blogs/deploy-kubeblocks-on-kubesphere/

    - text: 微宏科技基于 Kube AI Hub 的微服务架构实践
      description: Kube AI Hub 为微宏科技提供了 GUI 化的 Kubernetes 集群管理、CI/CD 流水线、服务网格治理等功能，简化了云原生技术的运用。
      link: https://kubesphere.io/zh/case/alphaflow/

    - text: Curve 分布式存储在 Kube AI Hub 中的实践
      description: 文章中详细介绍了如何在 Kube AI Hub 中部署 Curve 分布式存储。
      link: https://kubesphere.io/zh/blogs/kubesphere-curve/

    - text: 基于 JuiceFS 的 Kube AI Hub DevOps 项目数据迁移方案
    ...
    - text: 使用 KubeKey 快速离线部署 Kube AI Hub 集群
      description: 本教程使用 KubeKey 2.0.0 作为部署工具来实现 Kube AI Hub 集群在离线环境中的部署。
      link: https://kubesphere.io/zh/blogs/deploying-kubesphere-clusters-offline-with-kubekey/

    - text: Kubernetes 备份容灾服务产品体验教程
      description: Kube AI Hub Cloud 云原生备份容灾服务是 Kube AI Hub 团队针对混合云场景推出的 Kubernetes 备份容灾即服务产品。

...
topSection:
  ...
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会—成都站，成立于 2021 年  6 月 19 日，是由活跃在成都的 Kube AI Hub 社区用户和成员组成。初创核心成员 3 人。
...
station:
  ...
  name: 
    ...
    text2: 社区用户委员会—成都站
  description: 
    - 不管你是否是 Kube AI Hub 的用户，只要你对云原生技术感兴趣，对组织活动有热情，对发展 Kube AI Hub 社区有想法，即可申请加入 Kube AI Hub 社区成都用户委员会。
    - 如果你想加入 Kube AI Hub 社区用户委员会—成都站，成为其中的一名委员（成员），为发展 Kube AI Hub 社区贡献自己的一份力量，可添加成都站站长微信申请，并可加入 Kube AI Hub 开源社区成都站微信群。
  manager: 
    name: 周正军
...
returns:
  ...
  list:
    ...
    - text: Kube AI Hub 社区周边纪念礼品、社区认证证书及社区Title
...
activities:
  ...
  review:
    - text: 马上消费金融基于 Kube AI Hub 的 AI 平台的开发实践
      description: 本主题从 AI 平台业务架构，开发痛点等切入，介绍了引入 Kube AI Hub 的原因、过程、收获等；进而介绍了 Kube AI Hub 的部署架构、配置原理、二次开发等，力求打消 Kube AI Hub 的神秘感。
      link: https://kubesphere.io/zh/case/msxf/
      
    - text: 长虹电器基于 Kubernetes 的弹性伸缩与金丝雀发布实践
      description: 本文是 2021 Kube AI Hub Meetup 成都站讲师娄举分享内容整理而成，分享了长虹智能电视增值平台项目基础架构如何借助 Kube AI Hub 从旧有的传统模式迁移到 Kubernetes，以及使用 Kube AI Hub 如何进行弹性伸缩和金丝雀发布。

...
topSection:
  ...
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会—广州站，成立于 2022 年 8 月 6 日，是由活跃在广州的 Kube AI Hub 社区用户和成员组成的。初创核心成员 5 人。
...
station:
  ...
  name: 
    ...
    text2: 社区用户委员会—广州站
  description: 
    - 不管你是否是 Kube AI Hub 的用户，只要你对云原生技术感兴趣，对组织活动有热情，对发展 Kube AI Hub 社区有想法，即可申请加入 Kube AI Hub 社区广州用户委员会。
    - 如果你想加入 Kube AI Hub 社区用户委员会—广州站，成为其中的一名委员（成员），为发展 Kube AI Hub 社区贡献自己的一份力量，可添加广州站站长微信申请，并可加入 Kube AI Hub 开源社区广州站微信群。
  manager: 
    name: 裴振飞
...
activities:
  ...
  review:    
    ...
    - text: Kubernetes 多行日志采集方案探索
      description: 这篇文章介绍了如何使用 Kube AI Hub 收集和分析应用程序日志，并提供了相关的操作步骤。

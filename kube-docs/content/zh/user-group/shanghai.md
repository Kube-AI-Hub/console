...
topSection:
  ...
  committee: 社区用户委员会
  description: Kube AI Hub 社区用户委员会—上海站，成立于 2021 年 5 月 15 日，是由活跃在上海的 Kube AI Hub 社区用户和成员组成的。初创核心成员 4 人。
...
station:
  ...
  name: 
    ...
    text2: 社区用户委员会—上海站
  description: 
    - 不管你是否是 Kube AI Hub 的用户，只要你对云原生技术感兴趣，对组织活动有热情，对发展 Kube AI Hub 社区有想法，即可申请加入 Kube AI Hub 社区上海用户委员会。
    - 如果你想加入 Kube AI Hub 社区用户委员会—上海站，成为其中的一名委员（成员），为发展 Kube AI Hub 社区贡献自己的一份力量，可添加上海站站长微信申请，并可加入 Kube AI Hub 开源社区上海站微信群。
  manager: 
    name: 张海立
...
members:
  ...
  list:
    - name: 张海立
      position: 站长
      des: 驭势科技云平台研发总监，开源爱好者，云原生社区上海站 PMC 成员，Kube AI Hub Ambassador；日常云原生领域工作涉及 Kubernetes、DevOps、可观察性、服务网格等。
      image: /images/user-group/shanghai/zhanghaili.png
    ...
    - name: 马永兴
      position: 委员
      des: 中移上海产业研究院后端开发工程师，高级系统架构师，开源爱好者，主要工作云边协同、边缘计算方向，涉及 Kubernetes、Kube AI Hub、KubeEdge 开源社区等。
...
activities:
  ...
  review:    
    - text: Kube AI Hub 使用 HTTPS 协议集成 Harbor 镜像仓库指南
      description: 这篇文章介绍了 Harbor 的功能和使用方法，并讨论了在 Kube AI Hub 中使用 Harbor 的相关信息。
      link: https://kubesphere.io/zh/blogs/kubesphere-harbor/
    
    - text: Kube AI Hub 集群配置 NFS 存储解决方案
      description: 这篇文章介绍了在 Kube AI Hub 中使用 NFS 提供文件存储服务的方法，并讨论了相关的注意事项。
      link: https://kubesphere.io/zh/blogs/kubesphere-nfs/

    - text: 在 Kube AI Hub 中快速部署使用 GitLab 并构建 DevOps 项目
      description: 本次分享将和大家一起动手来实践一下在 Kube AI Hub 部署 GitLab CE（Community Edition 社区版）并构建与之联动的 DevOps 项目。
      link: https://kubesphere.io/zh/blogs/kubesphere-gitlab-devops/

    - text: 在 Kubernetes 中安装和使用 Apache APISIX Ingress 网关
      description: 通过 Kube AI Hub 的应用管理能力快速使用 Apache APISIX Ingress Controller
      link: https://kubesphere.io/zh/blogs/use-apache-apisix-ingress-in-kubesphere/

    - text: 在 Kubernetes 中部署云原生开发工具 Nocalhost
      description: 本文将介绍如何在 Kube AI Hub 中快速部署 Nocalhost Server，用于提供一个帮助研发团队统一管理 Nocalhost 应用部署的管理平台。
      link: https://kubesphere.io/zh/blogs/kubesphere-nocalhost/

    - text: 面向无人驾驶“云端大脑”可用性的云原生实践
      description: 本次分享介绍了驭势科技使用 Kube AI Hub 的历程，在云服务高可用方面自制 Operator 实现热备切换的工作，以及基于 SkyWalking 进行车云链路追踪的一些实践。

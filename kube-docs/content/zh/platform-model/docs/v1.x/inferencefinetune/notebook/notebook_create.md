...
description: "介绍如何在行业大模型平台创建开发实例，选择开发环境和算力资源。"
linkTitle: "创建开发实例"
weight: 6110
---
...
- 点击右上角个人头像，选择**新建开发实例**。
- 从顶部导航进入**开发环境**页面，再点击**新建开发实例**。
- 在模型详情页，点击**使用模型 → 使用 Notebook 开发**。

## 配置参数说明

进入开发实例创建页面后，填写以下配置信息：
...
创建完成后，可在**开发环境**页面查看所有已创建的实例及其运行状态；也可在**资源管理 → Notebook**区块中统一查看。

## 注意事项

{{< notice note >}}
- 开发实例按使用时长计费，不使用时请及时停止实例以避免额外费用。

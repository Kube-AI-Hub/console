# Kube AI Hub Localization Style Guide (for Simplified Chinese)

This style guide provides a set of editorial guidelines for those who are translating documentation for Kube AI Hub from English to Simplified Chinese. The general rules are basically the same as [Kube AI Hub Documentation Style Guide](https://github.com/kubesphere/website/blob/master/Kube AI Hub%20Documentation%20Style%20Guide.md), while you need to pay special attention to the following content due to language differences.
...
| Do                                         | Don't                                      |
| ------------------------------------------ | ------------------------------------------ |
| 这 3 个组件现已正常运行。                  | 这 3 个组件现已正常运行。                  |
| 您现在可以使用 admin 账号登录 KubeSphere。 | 您现在可以使用 admin 账号登录 KubeSphere。 |
...
| Do                                                                                   | Don't                                                                               |
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| 您可以将 Kube AI Hub 快速部署在不同的环境中（例如腾讯云、阿里云、AWS 以及 GCP 等）。 | 您可以将 Kube AI Hub 快速部署在不同的环境中 (例如腾讯云、阿里云、AWS 以及 GCP 等)。 |
| 您需要在防火墙中开启端口 30880（即 Kube AI Hub Web 控制台的 NodePort）。             | 您需要在防火墙中开启端口 30880 (即 Kube AI Hub Web 控制台的 NodePort)。             |
| Kube AI Hub 帮助您快速创建高可用 (HA) 集群。                                         | Kube AI Hub 帮助您快速创建高可用（HA）集群。                                        |
...
| Do          | Don't      |
| ----------- | ---------- |
| Kube AI Hub | kubesphere |
| Kubernetes  | kubernetes |
| MySQL       | Mysql      |

## Links

You can refer to [Links in Kube AI Hub Documentation Style Guide](https://github.com/kubesphere/website/blob/master/Kube AI Hub%20Documentation%20Style%20Guide.md#Links) for how to set internal and external links respectively. For external links in the target text, change the link to its Simplified Chinese version if it is available.

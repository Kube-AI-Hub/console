  ...
  nvidia: {
    modeOptions: [
      ...
      },
      {
        ...
        params: [
          {
            key: 'devicesplitcount',
            labelKey: 'GPU_DEVICE_SPLIT_COUNT',
            descKey: 'GPU_PARAM_DEVICE_SPLIT_COUNT_DESC',
            type: 'number',
            default: 10,
          },
        ],
      ...
      {
        labelKey: 'GPU_MODE_HAMI_CORE',
        value: 'hami-core',
        descKey: 'GPU_MODE_HAMI_CORE_DESC',
        params: [
          {
            key: 'devicesplitcount',
            labelKey: 'GPU_DEVICE_SPLIT_COUNT',
          ...
          {
            key: 'devicememoryscaling',
            labelKey: 'GPU_PARAM_DEVICE_MEMORY_SCALING',
            descKey: 'GPU_PARAM_DEVICE_MEMORY_SCALING_DESC',
            type: 'number',
            default: 1,
          },
          {
            key: 'devicecorescaling',
            labelKey: 'GPU_PARAM_DEVICE_CORE_SCALING',
            descKey: 'GPU_PARAM_DEVICE_CORE_SCALING_DESC',
            type: 'number',
            default: 1,
          },
        ],

...
module.exports = {
  ...
  CLUSTER_NODE_STATUS: '节点健康状态',
  ALL_NODES: '所有节点',
  HEALTHY_NODES: '健康节点',
  ONLINE_NODES: '在线节点',
  NODE_ONLINE_STATUS: '节点健康状态',
  ...
  MONITORING_STEP_AUTO_ADAPT_HINT: '采样间隔将根据所选时间范围自动调整，避免数据点过多导致查询超时或无数据。',
  ...
  // GPU Resource
  GPU_RESOURCE: '显卡资源',
  GPU_RESOURCE_DESC: '查看集群显卡资源的概览、物理资源监控与用量排行。',
  GPU_OVERVIEW: '概览',
  GPU_PHYSICAL_MONITORING: '物理资源监控',
  GPU_USAGE_RANKING: '资源用量排行',
  CLUSTER_GPU_STATUS: '显卡健康状态',
  GPU_ONLINE_STATUS: '显卡健康状态',
  HEALTHY_GPUS: '健康显卡',
  ALL_GPUS: '全部显卡',
  GPU_VENDOR_DISTRIBUTION: '显卡厂商分布',
  NODE_VENDOR_DISTRIBUTION: '节点厂商分布',
  GPU_MODEL_USAGE: '显卡型号用量',
  GPU_ID: '显卡 ID',
  SELECT_VENDOR: '选择厂商',
  SELECT_MODEL: '选择型号',
  ALL_MODELS: '全部型号',
  ...
  SORT_BY_NODE_GPU_ALLOCATED: '按 GPU 分配量排行',

...
module.exports = {
  ...
  SET_GPU_VIRT_MODE: '设置GPU 共享/虚拟化模式',
  SET: '设置',
  GPU_MODE: 'GPU 模式',
  SET_GPU_VIRT_MODE_DESC: '设置节点的 GPU 共享/虚拟化模式，将驱动与 Device Plugin 切换到所选模式。',
  GPU_VIRT_MODE_SWITCHING: '切换中 (目标: {mode})',
  GPU_VIRT_MODE_SWITCH_FAILED: '切换失败',
  GPU_VIRT_MODE_VENDOR_NOT_SUPPORTED: '当前 GPU 厂商暂不支持在控制台切换共享/虚拟化模式。',

...
module.exports = {
  ...
  CreateContainerConfigError: 'Create Container Config Error',
  ...
  SCHEDULED_TO_GPU: 'Scheduled to GPU',
  GPU_ALLOCATED_VENDOR: 'Vendor: {value}',
  GPU_ALLOCATED_MEMORY: 'Memory: {value} Mi',
  GPU_ALLOCATED_CORE: 'Core: {value}%',

...
module.exports = {
  ...
  SET_GPU_VIRT_MODE: 'Set GPU Shared/Virtualization Mode',
  SET: 'Set',
  GPU_MODE: 'GPU Mode',
  SET_GPU_VIRT_MODE_DESC: 'Set the node GPU shared/virtualization mode; driver and Device Plugin will be switched to the selected mode.',
  GPU_VIRT_MODE_SWITCHING: 'Switching (target: {mode})',
  GPU_VIRT_MODE_SWITCH_FAILED: 'Switch failed',
  GPU_VIRT_MODE_VENDOR_NOT_SUPPORTED: 'The current GPU vendor does not support switching shared/virtualization mode from the console.',
  ...
  VIRTUAL_GPU_TOTAL: 'Shared/Virtual GPU Total',
  VIRTUAL_GPU_TOTAL_SCAP: 'shared/virtual GPU total',
  ...
  GPU_CARD_VGPU: 'Shared/Virtual GPU',
  GPU_CARD_COMPUTE: 'Core',
  GPU_CARD_MEMORY: 'Memory',

...
module.exports = {
  ...
  CLUSTER_NODE_STATUS: 'Node Health Status',
  ALL_NODES: 'All nodes',
  HEALTHY_NODES: 'Healthy Nodes',
  ONLINE_NODES: 'Online nodes',
  NODE_ONLINE_STATUS: 'Node Health Status',
  ...
  MONITORING_STEP_AUTO_ADAPT_HINT: 'Sampling interval is automatically adjusted based on the selected time range to avoid too many data points and ensure query results are returned correctly.',
  ...
  GPU_RESOURCE_DESC: 'View cluster GPU resource overview, physical resource monitoring and usage ranking.',
  GPU_OVERVIEW: 'Overview',
  GPU_PHYSICAL_MONITORING: 'Physical Resource Monitoring',
  GPU_USAGE_RANKING: 'Resource Usage Ranking',
  CLUSTER_GPU_STATUS: 'GPU Health Status',
  GPU_ONLINE_STATUS: 'GPU Health Status',
  HEALTHY_GPUS: 'Healthy GPUs',
  ALL_GPUS: 'All GPUs',
  GPU_VENDOR_DISTRIBUTION: 'GPU Vendor Distribution',
  NODE_VENDOR_DISTRIBUTION: 'Node Vendor Distribution',
  GPU_MODEL_USAGE: 'GPU Model Usage',
  GPU_ID: 'GPU ID',
